...
CREATE TABLE IF NOT EXISTS `peel_admins_contacts_planified` (
  ...
  `admin_id` int(11) unsigned NOT NULL DEFAULT '0',
  `timestamp` int(11) unsigned NOT NULL DEFAULT '0',
  `reason` enum('','interesting_profile','interested_by_product','payment_expected','follow_up') NOT NULL DEFAULT '',
...
--
-- Structure de la table `peel_quantites`
--
...
--
-- Contenu de la table `peel_quantites`
--
...
CREATE TABLE IF NOT EXISTS `peel_utilisateurs` (
  ...
  `next_contact_reason` enum('', 'renewal_expected', 'payment_expected', 'planified', 'commercial_action', 'usual') NOT NULL DEFAULT '',
