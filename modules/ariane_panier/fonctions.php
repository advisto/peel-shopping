...
// +----------------------------------------------------------------------+
// $Id: fonctions.php 64928 2020-11-05 10:50:06Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
