...
// +----------------------------------------------------------------------+
// $Id: open-flash-chart.php 55332 2017-12-01 10:44:06Z sdelaporte $
 ...
 * @version $Id: open-flash-chart.php 55332 2017-12-01 10:44:06Z sdelaporte $
 * @access public
 */
class graph
{
	...
	*/
	function __construct()
	{
		...
		$this->width = 250;
		$this->height = 200;
		$this->js_path = $GLOBALS['wwwroot'].'/lib/js/';
		$this->swf_path = '';
		$this->x_labels = array();
		$this->y_min = '';
		$this->y_max = '';
	...
	*/
	...
	{
		$this->unique_id = uniqid(mt_rand(), true);
	}
	...
	*/
	...
	function render()
	{
		...
		if($this->output_type == 'js')
		{
			...
			$tmp[] = 'so.addVariable("wmode", "transparent");';
