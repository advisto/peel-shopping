...
// +----------------------------------------------------------------------+
// $Id: advisto-chart.php 39443 2014-01-06 16:44:24Z sdelaporte $
 ...
 * @return
 */
function advistoChart(&$data, $title = null, $all_graph_type = null, $graph_type = array(), $colors = array(), $legend_font_size = 12, $width = 300)
{
	if(empty($width)){
		$width=300;
	}
