            ...
            function drawPie() {
                ...
                function drawLabels() {
                    ...
                    function drawLabel(slice, startAngle, index) {
                        ...
                        var labelTop = Math.min(Math.max(0,(y - label.height() / 2)), canvasWidth - label.width());
                        var labelLeft = Math.min(Math.max(0,(x - label.width() / 2)), canvasHeight - label.height());
						...
						for(var j=0; j<labels.length; j++)
						{
							...
							if(match)
							{
								var newTop = Math.max(0, tmpPos[1][0] - (label.height() +1 ));
								if(newTop == 0) {
									newTop = Math.min(tmpPos[1][1], canvasWidth - label.width());
								}
