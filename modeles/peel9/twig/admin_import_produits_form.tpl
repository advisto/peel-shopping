	...
	<table class="full_width">
		...
		<tr>
			<td>
				<div class="alert alert-info">
					...
					{{ STR_ADMIN_IMPORT_FILE_EXAMPLE }}{{ STR_BEFORE_TWO_POINTS }}: <a href="{{ example_href|escape('html') }}">exemple_prod.csv</a><br />
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
		  	<td class="center">
				...
				<p>{{ STR_ADMIN_IMPORT_FILE_NAME }}{{ STR_BEFORE_TWO_POINTS }}: <input type="file" name="fichier" /></p>
