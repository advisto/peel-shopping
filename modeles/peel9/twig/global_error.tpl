...
// +----------------------------------------------------------------------+
// $Id: global_error.tpl 55304 2017-11-28 15:49:01Z sdelaporte $
#}<div class="clearfix"></div>
<div class="alert alert-danger fade in">
	{% if box_dismiss_disable is empty %}<button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>{% endif %}
