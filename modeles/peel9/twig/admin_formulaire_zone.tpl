...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_zone.tpl 53849 2017-05-19 12:29:39Z sdelaporte $
#}<form class="entryform form-inline" role="form" method="post" action="{{ action|escape('html') }}">
	...
	<table class="full_width">
		...
		<tr>
			...
			<td>
				<input type="radio" value="amount" name="applied_franco_mode" {% if applied_franco_mode == 'amount' %} checked="checked" {% endif %}> {$STR_ADMIN_ZONES_APPLY_MODE_ON_AMOUNT}
				<input type="radio" value="weight" name="applied_franco_mode" {% if applied_franco_mode == 'weight' %} checked="checked" {% endif %}> {$STR_ADMIN_ZONES_APPLY_MODE_ON_WEIGHT}
				<input type="radio" value="" name="applied_franco_mode" {% if applied_franco_mode is empty %} checked="checked" {% endif %}> {$STR_ADMIN_ZONES_APPLY_FRANCO_MODE_NO}
			</td>
		</tr>
		<tr>
