...
// +----------------------------------------------------------------------+
// $Id: user_register_form.tpl 55291 2017-11-27 17:13:45Z sdelaporte $
...
{% if short_register_form is empty %}
	...
	{% if (STR_FONCTION) %}
				...
				<div id="popover" class="hidden" style="top: 628.1px; left: 723.633px; display: block;"><div class="arrow"></div><div id="message_option" class="popover-content"></div></div>
				</div>
	{% endif %}
	{% if (STR_NAISSANCE) %}
			<div class="enregistrement">
