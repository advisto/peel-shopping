...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_couleur.tpl 53200 2017-03-20 11:19:46Z sdelaporte $
#}<form class="entryform form-inline" role="form" method="post" action="{{ action|escape('html') }}">
	...
	<table class="full_width">
		...
		<tr>
			...
			<td><input style="width:100px" type="text" class="form-control" name="prix" value="{{ prix|str_form_value }}" /></td>
 		</tr>
		<tr>
			<td class="title_label">{{ STR_ADMIN_RESELLER_PRICE }}{{ STR_BEFORE_TWO_POINTS }}:</td>
			<td><input style="width:100px" type="text" class="form-control" name="prix_revendeur" value="{{ prix_revendeur|str_form_value }}" /></td>
 		</tr>
		<tr>
