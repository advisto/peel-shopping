...
// +----------------------------------------------------------------------+
// $Id: admin_liste_couleur.tpl 53200 2017-03-20 11:19:46Z sdelaporte $
#}
...
{% else %}
		<tbody>
			<tr><td colspan="3"><div class="alert alert-warning">{{ STR_ADMIN_COULEURS_NO_COLOR_FOUND }}</div></td></tr>
		</tbody>
{% endif %}
	</table>
</div>