...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_langue.tpl 53200 2017-03-20 11:19:46Z sdelaporte $
...
<form class="entryform form-inline" role="form" method="post" action="{{ action|escape('html') }}" enctype="multipart/form-data">
	...
	<table class="full_width">
		...
		<tr>
			...
			{% else %}
				<input type="text" class="form-control" name="lang" style="width:50px" maxlength="2" value="{{ lang|str_form_value }}" /> {{ STR_ADMIN_LANGUES_CODE_ISO_EXPLAIN }}
		...
		<tr>
			...
			<td>
				...
				<input type="radio" name="etat" value="-1"{% if etat == '-1' %} checked="checked"{% endif %} /> {{ STR_ADMINISTRATION }}
			</td>
		</tr>
		<tr>
