...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_pays.tpl 55305 2017-11-28 15:49:56Z sdelaporte $
#}<form class="entryform form-inline" role="form" method="post" action="{{ action|escape('html') }}" enctype="multipart/form-data">
	...
	<table class="full_width">
		...
		<tr>
			...
			<td>
				<select class="form-control" {% if site_id_select_multiple %} name="zone[]" multiple="multiple" size="5"{% else %} name="zone"{% endif %}>
				{% for o in options %}
