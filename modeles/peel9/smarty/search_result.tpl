...
<h1 property="name" class="search_result">{$STR_RESULT_SEARCH} {$search|strtoupper} {if !empty($attributs_list)} {$attributs_list} {/if}{$STR_SEARCH_RESULT_PRODUCT} - {$products_found} {$STR_CADDIE_OBJECTS_COUNT}</h1>
...
{if !empty($are_terms)}
	{if !empty($arts_found)}
<h2 class="search_result">{$STR_RESULT_SEARCH} {$search|strtoupper} {$STR_SEARCH_RESULT_ARTICLE} - {$arts_found|@count} {$STR_ARTICLES_PLURAL_OPTIONAL}</h2>
...
<h2 class="search_result">{$STR_RESULT_SEARCH} {$search|strtoupper} {$STR_SEARCH_RESULT_BRAND} - {$brands_found|@count} {$STR_BRAND}</h2>
