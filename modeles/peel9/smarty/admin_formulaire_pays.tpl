...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_pays.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
*}<form class="entryform form-inline" role="form" method="post" action="{$action|escape:'html'}" enctype="multipart/form-data">
	...
	<table class="full_width">
		...
		<tr>
			...
			<td><input style="width:100px" type="number" class="form-control" name="iso_num" value="{$iso_num|str_form_value}" /></td>
		</tr>
		<tr><td colspan="2" class="bloc"><h2>{$STR_ADMIN_SEPARATOR_PRICE}</h2></td></tr>
		<tr>
			<td class="title_label">{$STR_ADMIN_DECIMAL_SEPARATOR_PRICE}</td>
			<td><input style="width:100px" type="text" class="form-control" name="prices_decimal_separator" value="{$prices_decimal_separator|str_form_value}" /></td>
		</tr>
		<tr>
			<td class="title_label">{$STR_ADMIN_THOUSANDS_SEPARATOR_PRICE}</td>
			<td><input style="width:100px" type="text" class="form-control" name="prices_thousands_separator" value="{$prices_thousands_separator|str_form_value}" /></td>
		</tr>
		...
		<tr>
			...
			<td>
				<select class="form-control" {if $site_id_select_multiple} name="zone[]" multiple="multiple" size="5"{else} name="zone"{/if}>
		...
		<tr>
			...
			<td><input type="number"  style="width:100px" class="form-control" name="position" value="{$position|str_form_value}" /></td>
		</tr>
