...
// +----------------------------------------------------------------------+
// $Id: admin_liste_contacts.tpl 66961 2021-05-24 13:26:45Z sdelaporte $
*}<div class="entete">{$STR_ADMIN_CONTACTS_TITLE}</div>
<div style="margin-top:5px;">
	<p><a href="{$add_href|escape:'html'}" class="btn btn-primary"><span class="glyphicon glyphicon-plus" title=""></span> {$STR_ADMIN_CONTACTS_ADD}</a></p>
</div>
