...
// +----------------------------------------------------------------------+
// $Id: commercialeAdmin_form_contact_user.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
...
{if isset($rce)}
<form class="entryform form-inline" role="form" method="post" action="{$action|escape:'html'}" id="contact_planified" >
...
{/if}
{if $are_results}
<form class="entryform form-inline" role="form" method="post" action="{$modif_action}">
