...
// +----------------------------------------------------------------------+
// $Id: avisAdmin_liste.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
*}
<div class="entete">{$STR_MODULE_AVIS_ADMIN_LIST}</div>
	<div style="margin-top:5px;">
		<p><a href="{$add_prod_href|escape:'html'}" class="btn btn-primary"><span class="glyphicon glyphicon-plus" title=""></span> {$STR_MODULE_AVIS_ADMIN_ADD_ON_PRODUCT}</a></p>
	</div>
<p>
