...
// +----------------------------------------------------------------------+
// $Id: installation_verifdroits.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
*}
<form class="entryform form-inline" role="form" action="{$configuration_url|str_form_value}" method="post">
	...
	<p class="center">
	<br />
		<input type="button" value="{$STR_REFRESH|str_form_value}" onclick="location='verifdroits.php'" class="btn btn-success" /> &nbsp; &nbsp;
		<input type="submit" value="{$STR_ADMIN_INSTALL_CONTINUE_WITH_ERRORS_BUTTON|str_form_value}" class="btn btn-primary btn-lg" />
	</p>
	{/if}
 </form>