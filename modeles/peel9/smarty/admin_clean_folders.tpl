...
// +----------------------------------------------------------------------+
// $Id: admin_clean_folders.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
*}<div class="center">
	...
	<form class="entryform form-inline" role="form" method="post" action="{$action_images|escape:'html'}">
		<table class="main_table">
			...
			<tr>
				...
				<td><span style="word-wrap: break-word;">{$dirroot}</span>/<input style="width:120px;" size="50" type="text" class="form-control" name="file_shortpath" value="{$file_shortpath|str_form_value}" /></td>
			<tr>
			<tr>
				<td class="top"><b>{$STR_ADMIN_CLEAN_FOLDERS_MINIMAL_SIZE}</b></td>
				<td><input style="width:120px;" type="number" class="form-control" name="size_ko" value="{$size_ko|str_form_value}" /> {$STR_KILOBYTE}</td>
			</tr>
			<tr>
				<td class="top"><b>{$STR_ADMIN_CLEAN_FOLDERS_QUALITY}</b></td>
				<td><input style="width:120px;" type="number" class="form-control" name="tx_qualite" value="{$tx_qualite|str_form_value}" /> %</td>
			</tr>
			<tr>
				<td class="top"><b>{$STR_ADMIN_CLEAN_FOLDERS_ENLIGHTEN_IMAGE}</b></td>
				<td><input type="checkbox" name="enlighten" value="1"{if $enlighten == "on"} checked="checked"{/if} /></td>
			</tr>
			<tr>
