...
// +----------------------------------------------------------------------+
// $Id: admin_utilisateur_form.tpl 67314 2021-06-21 13:37:40Z sdelaporte $
*}
...
<ul class="nav nav-tabs">
	...
	{if !empty($is_annonces_module_active)}
...
{/if}
			...
			<tr>
				...
				<td class="menu center">{$STR_TOTAL} {$ttc_ht}</td>
	...
	<div class="tab-pane" id="tab4">
		...
		{if $is_id_utilisateur}
			...
			{/if}
			{if isset($actions_moderations_user)}
			<table class="full_width" >
				<tr>
	...
	<div class="tab-pane" id="tab5">
			{if isset($affiche_recherche_connexion_user)}
			<table class="full_width">
				<tr>
