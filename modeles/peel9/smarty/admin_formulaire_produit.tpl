...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_produit.tpl 64741 2020-10-21 13:48:51Z sdelaporte $
...
{/if}
	...
	{if $products_table_additionnal_fields}
		...
		<tr>
			...
			<td><input type="checkbox" value="1" {if {$field.value|str_form_value}==1} checked="checked"{/if} id="{$field.name|str_form_value}" name="{$field.name|str_form_value}" /></td>
			{else}
