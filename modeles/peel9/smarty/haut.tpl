...
// +----------------------------------------------------------------------+
// $Id: haut.tpl 60372 2019-04-12 12:35:34Z sdelaporte $
*}<!DOCTYPE html>
	...
	<body vocab="http://schema.org/" typeof="WebPage">
		...
		<div id="total" class="clearfix page_{$page_name}">
			...
			<header id="main_header">
				<div class="navbar yamm navbar-default navbar-static-top" id="{$header_html_configuration}">
