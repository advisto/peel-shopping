...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_taille.tpl 53676 2017-04-25 14:51:39Z sdelaporte $
*}<form class="entryform form-inline" role="form" method="post" action="{$action|escape:'html'}">
	...
	<table class="full_width">
		...
		<tr>
			...
			<td><select class="form-control" name="signe"><option value="+"{if $signe == "+"} selected="selected"{/if}>+</option><option value="-"{if $signe == "-"} selected="selected"{/if}>-</option></select></td></tr>
		<tr>
