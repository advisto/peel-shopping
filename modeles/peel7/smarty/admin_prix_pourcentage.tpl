...
// +----------------------------------------------------------------------+
// $Id: admin_prix_pourcentage.tpl 36927 2013-05-23 16:15:39Z gboussin $
	...
	<table class="full_width">
		...
		<tr class="middle">
			<td colspan="3" style="text-align:center;padding-top:15px;">
				...
				<input class="formulaire3" type="text"{if !empty($percent_prod)} value="{$percent_prod|str_form_value}"{/if} name="percent_prod" size="8" />
