...
// +----------------------------------------------------------------------+
// $Id: admin_commande_liste_download.tpl 35805 2013-03-10 20:43:50Z gboussin $
*}<table cellpadding="2" width="100%">
	...
	{$res.tr_rollover}
		<td class="center">
			...
			{if $allow_delete_order}<a onclick="return confirm('{$res.delete_confirm_txt|filtre_javascript:true:true:true}');" href="{$res.drop_href|escape:'html'}"><img src="{$drop_src|escape:'html'}" alt="{$STR_DELETE|str_form_value}" />{/if}
		</td>
