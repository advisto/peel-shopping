...
// +----------------------------------------------------------------------+
// $Id: uploaded_file.tpl 49833 2016-05-11 16:52:56Z sdelaporte $
*}
...
{elseif $site_parameters.used_uploader=="fineuploader"}
	<div {if isset($f.form_name)}id="{$f.form_name|replace:'[':'_openarray_'|replace:']':'_closearray_'|str_form_value}"{/if} class="uploader"></div>
