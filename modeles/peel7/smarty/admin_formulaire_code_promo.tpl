...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_code_promo.tpl 35064 2013-02-08 14:16:40Z gboussin $
*}<form method="post" action="{$action|escape:'html'}">
	...
	<table class="main_table">
		...
		<tr>
			<td class="label">{$STR_PROMO_CODE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input type="text" name="nom" size="40" value="{$nom|str_form_value}" /></td>
		</tr>
		<tr>
			<td class="label">{$STR_ADMIN_BEGIN_DATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input type="text" name="date_debut" class="datepicker" size="40" value="{$date_debut|str_form_value}" /></td>
		</tr>
		<tr>
			<td class="label">{$STR_ADMIN_END_DATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input type="text" name="date_fin" class="datepicker" size="40" value="{$date_fin|str_form_value}" /></td>
		</tr>
		{if $on_type == 1}
		<tr>
		...
		<tr>
			...
			<td>
		  		<select size="1" name="id_categorie" >
		...
		<tr>
			<td class="label" colspan="2">{$STR_ADMIN_CODES_PROMOS_ALREADY_USED}</td>
		</tr>
		<tr>
			<td class="label" colspan="2">&nbsp;</td>
		</tr>
		<tr>
			<td class="label">{$STR_ADMIN_CODES_PROMOS_STATUS}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
