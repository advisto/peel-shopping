...
// +----------------------------------------------------------------------+
// $Id: user_register_form.tpl 47145 2015-10-04 11:56:35Z sdelaporte $
...
{/if}
	...
	{/if}
						<p class="center">{$token}<input class="btn btn-primary btn-lg" type="submit" value="{$submit_text|str_form_value}" /></p>
						<p>{$cnil_txt}</p>
					</div>
				</td>
			</tr>
