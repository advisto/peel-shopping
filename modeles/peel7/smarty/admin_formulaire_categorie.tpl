...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_categorie.tpl 49833 2016-05-11 16:52:56Z sdelaporte $
*}<form class="entryform form-inline" role="form" method="post" action="{$action|escape:'html'}" enctype="multipart/form-data">
	...
	{if $is_category_promotion_module_active || $is_lot_module_active}
		...
		{if $is_lot_module_active}
			...
			{else}
			<tr>
				<td colspan="2"><div class="alert alert-info"><p>{$STR_ADMIN_PRODUITS_LOT_PRICE_HANDLE_EXPLAIN}</p></div></td>
			</tr>
			{/if}
		{/if}
	{/if}
