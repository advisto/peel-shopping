...
// +----------------------------------------------------------------------+
// $Id: installation_configuration.tpl 39443 2014-01-06 16:44:24Z sdelaporte $
*}
<form class="entryform form-inline" role="form" action="{$next_step_url|escape:'html'}" method="post">
	...
	<div class="col"><input type="text" class="form-control" name="motdepasse" size="30" /><br /></div>
