...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_marque.tpl 36232 2013-04-05 13:16:01Z gboussin $
...
{foreach $langs as $l}
		...
		<tr>
			<td class="label" colspan="2">{$STR_ADMIN_NAME}{$STR_BEFORE_TWO_POINTS}: {$l.error}</td>
		</tr>
		<tr>
			<td colspan="2"><input style="width: 100%" type="text" name="nom_{$l.lng}" value="{$l.nom|html_entity_decode_if_needed|str_form_value}" /></td>
		</tr>
		<tr>
			<td colspan="2" class="label">{$STR_ADMIN_DESCRIPTION}{$STR_BEFORE_TWO_POINTS}:</td>
		</tr>
		<tr>
...
{/foreach}
		...
		{if isset($image)}
		<tr>
			<td colspan="2" class="label">{$STR_ADMIN_IMAGE}{$STR_BEFORE_TWO_POINTS}:<br />
		...
		{else}
		<tr>
			<td colspan="2" class="label">{$STR_ADMIN_IMAGE}{$STR_BEFORE_TWO_POINTS}:</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="label">{$STR_ADMIN_MARQUES_DISCOUNT_ON_BRAND}{$STR_BEFORE_TWO_POINTS}:</td>
		...
		{/if}
		<tr>
			<td colspan="2" class="center"><br /><input class="bouton" type="submit" value="{$titre_soumet|str_form_value}" /></td>
		</tr>
	</table>
</form>