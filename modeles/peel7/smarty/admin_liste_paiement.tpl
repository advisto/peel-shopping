...
// +----------------------------------------------------------------------+
// $Id: admin_liste_paiement.tpl 39443 2014-01-06 16:44:24Z sdelaporte $
...
<div class="table-responsive">
	...
	{else}
		<tbody class="sortable">
			<tr><td colspan="6"><div class="alert alert-warning">{$STR_ADMIN_PAIEMENT_NO_PAYMENT_MEAN_FOUND}</div></td></tr>
		</tbody>
	{/if}
	</table>
</div>