...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_home.tpl 35064 2013-02-08 14:16:40Z gboussin $
	...
	<table class="main_table">
		...
		<tr>
			...
			<td>
				...
				<input type="radio" name="emplacement" value="home_bottom" id="home_bottom"{if $emplacement == 'home_bottom'} checked="checked"{/if} /><label for="home_bottom">{$STR_ADMIN_HTML_PLACE_HOME_BOTTOM}</label><br />
				...
				<input type="radio" name="emplacement" value="error404" id="emplacement_error404"{if $emplacement == 'error404'} checked="checked"{/if} /><label for="emplacement_error404">{$STR_ADMIN_HTML_PLACE_ERROR404}</label><br />
				<input type="radio" name="emplacement" value="scrolling" id="emplacement_scrolling"{if $emplacement == 'scrolling'} checked="checked"{/if} /><label for="emplacement_scrolling">{$STR_ADMIN_HTML_PLACE_SCROLLING}</label><br />
				<input type="radio" name="emplacement" value="contact_page" id="contact_page"{if $emplacement == 'contact_page'} checked="checked"{/if} /><label for="contact_page">{$STR_ADMIN_HTML_PLACE_CONTACT_PAGE}</label><br />
