...
// +----------------------------------------------------------------------+
// $Id: admin_bas.tpl 39495 2014-01-14 11:08:09Z sdelaporte $
*}				</div>
			</div>
		</div>
		<div class="push"></div>
	...
	<div id="footer">
		<div class="container">
			<footer class="footer">
				...
				<div class="under_footer">{$STR_ADMIN_SUPPORT}{$STR_BEFORE_TWO_POINTS}: <a href="{$peel_support_href|escape:'html'}" onclick="return(window.open(this.href)?false:true);">{$STR_ADMIN_CONTACT_PEEL}</a> - {$STR_ADMIN_CONTACT_PEEL_ADDRESS}</div>
			</footer>
		</div>
	</div>
	<!-- Fin Total -->
