...
// +----------------------------------------------------------------------+
// $Id: commercialeAdmin_list_contact.tpl 43037 2014-10-29 12:01:40Z sdelaporte $
*}<form class="entryform form-inline" role="form" method="get" action="{$action|escape:'html'}">
	<table class="full_width">
		...
		<tr>
			...
			<td>
				<input name="ad_date" type="text" class="form-control datepicker" value="{if !empty($ad_date)}{$ad_date|str_form_value}{/if}" title="{$STR_ADMIN_INPUT_SEARCH|str_form_value}" style="width:110px;" />
			</td>
		</tr>
		<tr>
