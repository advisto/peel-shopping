...
// +----------------------------------------------------------------------+
// $Id: commercialeAdmin_list_contact.tpl 35805 2013-03-10 20:43:50Z gboussin $
*}<form method="get" action="{$action|escape:'html'}">
	<table style="border:0;cellpadding:0;cellspacing:0;width:100%;">
		...
		<tr>
			...
			<td>
				<input name="login_to_contact" maxlength="100" type="text" value="{if !empty($login_to_contact)}{$login_to_contact|str_form_value}{/if}" title="{$STR_ADMIN_INPUT_SEARCH|str_form_value}" style="width:200px;" />
			</td>
		</tr>
		<tr>
			<th>{$STR_MODULE_COMMERCIAL_ADMIN_NAME_TO_CONTACT}{$STR_BEFORE_TWO_POINTS}:</th>
			<td>
				<input name="nom_to_contact" maxlength="100" type="text" value="{if !empty($nom_to_contact)}{$nom_to_contact|str_form_value}{/if}" title="{$STR_ADMIN_INPUT_SEARCH|str_form_value}" style="width:200px;" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input name="ad_date" maxlength="30" size="30" type="text" class="datepicker" value="{if !empty($ad_date)}{$ad_date|str_form_value}{/if}" title="{$STR_ADMIN_INPUT_SEARCH|str_form_value}" style="width:80px;" />
			</td>
		</tr>
		<tr>
