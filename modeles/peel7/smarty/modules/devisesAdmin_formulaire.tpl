...
// +----------------------------------------------------------------------+
// $Id: devisesAdmin_formulaire.tpl 55332 2017-12-01 10:44:06Z sdelaporte $
*}<form name="entryform" method="post" action="{$action|escape:'html'}">
	...
	<table class="main_table">
		...
		<tr>
			...
			<td><input type="radio" name="symbole_place" value="1"{if $symbole_place == "1"} checked="checked"{/if} /></td>
		</tr>
		<tr>
			<td>{$STR_MODULE_DEVISES_ADMIN_SYMBOL_AT_LEFT}</td>
			<td><input type="radio" name="symbole_place" value="0"{if $symbole_place == "0"} checked="checked"{/if} /></td>
		</tr>
		<tr>
