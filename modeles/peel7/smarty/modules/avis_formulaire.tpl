...
// +----------------------------------------------------------------------+
// $Id: avis_formulaire.tpl 47592 2015-10-30 16:40:22Z sdelaporte $
	...
	{/if}
			<tr>
				<td colspan="2" class="center">
					...
					<input type="hidden" name="mode" value="{if !empty($opinion_id)}modif{else}insere{/if}" />
