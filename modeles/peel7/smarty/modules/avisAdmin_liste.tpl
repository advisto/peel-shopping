...
// +----------------------------------------------------------------------+
// $Id: avisAdmin_liste.tpl 43037 2014-10-29 12:01:40Z sdelaporte $
*}
...
<div class="table-responsive">
	...
	{foreach $results as $res}
		...
		<td class="center">{for $foo=1 to $res.note}<img src="{$star_src|escape:'html'}" alt="" style="vertical-align:middle" />{/for}</td>
	...
	{foreachelse}
		<tr><td colspan="7"><div class="alert alert-warning">{$STR_MODULE_AVIS_ADMIN_NOTHING_FOUND}</div></td></tr>
	{/foreach}
	</table>
</div>
