...
// +----------------------------------------------------------------------+
// $Id: profilAdmin_formulaire_profil.tpl 36927 2013-05-23 16:15:39Z gboussin $
...
{foreach $langs as $l}
		...
		<tr>
			...
			<td style="width:540px"><input type="text" name="name_{$l.lng}" style="width:100%" value="{$l.name|str_form_value}" /></td>
		</tr>
		<tr>
