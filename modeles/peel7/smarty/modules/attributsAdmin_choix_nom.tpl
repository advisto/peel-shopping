...
// +----------------------------------------------------------------------+
// $Id: attributsAdmin_choix_nom.tpl 35805 2013-03-10 20:43:50Z gboussin $
	...
	<tr>
		<td>
			<p><b>{$STR_MODULE_ATTRIBUTS_ADMIN_SEARCH_CHOOSE_ATTRIBUTE}{$STR_BEFORE_TWO_POINTS}:</b></font>
				<select name="categorie" onchange="document.location='{$wwwroot_in_admin}/modules/attributs/administrer/attributs.php?mode=liste&amp;attid='+this.options[this.selectedIndex].value">
