...
// +----------------------------------------------------------------------+
// $Id: pensebete_display.tpl 44077 2015-02-17 10:20:38Z sdelaporte $
...
<div class="table-responsive">
	<table class="table table-striped table-hover reminder_array" aria-label="{$STR_TABLE_SUMMARY_CADDIE|str_form_value}">
		...
		{foreach $prods as $p}
			<tr>
				<td class="lignecaddie_suppression"><a href="{$p.del_href|escape:'html'}"><span class="glyphicon glyphicon-remove-sign" title="{$STR_DELETE_PROD_CART|str_form_value}" style="color: #FF0000; font-size:22px;"></span></a>
				</td>
				<td class="lignecaddie_produit_image">
				{if !empty($p.img)}
					<a href="{$p.urlprod}"><img src="{$p.img}" alt="" width="100" /></a>
				{/if}
				</td>
