...
*}<form class="entryform form-inline" role="form" method="post" action="{$action|escape:'html'}" enctype="multipart/form-data">
	...
	{if $is_gifts_module_active}
		...
		<tr id="on_gift_points_tr">
			...
			<td><input type="text" class="form-control" value="{$on_gift_points|html_entity_decode_if_needed|str_form_value}" name="on_gift_points" id="on_gift_points" /></td>
		</tr>
		<tr>
	...
	{foreach $colors as $c}
		...
		{if !empty($f)}
		<tr>
			<td class="title_label">{$STR_ADMIN_IMAGE} {$i}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
