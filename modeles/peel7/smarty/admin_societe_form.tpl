...
// +----------------------------------------------------------------------+
// $Id: admin_societe_form.tpl 37098 2013-06-01 22:27:03Z gboussin $
*}<form method="post" action="{$action|escape:'html'}">
	...
	<table class="main_table">
		...
		<tr>
			...
			<td><input type="url" name="siteweb" style="width:100%" placeholder="http://" value="{$siteweb|str_form_value}" /></td>
		</tr>
		<tr>
