...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_site.tpl 35369 2013-02-18 14:03:15Z gboussin $
*}<form method="post" action="{$action|escape:'html'}" enctype="multipart/form-data">
	...
	<table class="main_table">
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_EXPLAIN}</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_SITE_ACTIVATED_EXPLAIN}<br />
	...
	{/foreach}
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_CSS_FILES_EXPLAIN}</div></td>
   	 	</tr>
	{foreach $langs as $l}
		<tr>
	...
	{/foreach}
		...
		<tr>
			...
			{else}
				<input style="width:250px" type="file" name="favicon" value="" />
			{/if}
			</td>
   	 	</tr>
		<tr>
		...
		<tr>
 			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_JAVASCRIPT_LIBRARIES_ACTIVATION_EXPLAIN}</div>
			</td>
	 	</tr>
		<tr>
		...
		<tr>
			...
			<td><input style="width:100px" maxlength="3" type="text" name="module_autosend_delay" value="{$module_autosend_delay|str_form_value}" /> {$STR_ADMIN_SITES_PAYMENT_FORM_AUTO_VALIDATION_WAIT_SECONDS_EXPLAIN}
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<div class="global_help">{$STR_ADMIN_SITES_CART_POPUP_SIZE_EXPLAIN}</div>
				<input type="text" maxlength="3" name="popup_width" value="{$popup_width|str_form_value}" /> px *
				<input type="text" maxlength="3" name="popup_height" value="{$popup_height|str_form_value}" /> px
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_ADMIN_FORCE_SSL_EXPLAIN}<br />
<a href="{$membre_href|escape:'html'}">{$STR_ADMIN_SITES_HTTPS_TEST}</a></div>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_DISPLAY_ERRORS_FOR_IP_EXPLAIN}</div></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" maxlength="3" name="small_width" value="{$small_width|str_form_value}" /> px. *
				<input type="text" maxlength="3" name="small_height" value="{$small_height|str_form_value}" /> px.
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_IMAGES_SIZE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="text" maxlength="3" style="width:100px" name="medium_width" value="{$medium_width|str_form_value}" /> px. *
				<input type="text" maxlength="3" style="width:100px" name="medium_height" value="{$medium_height|str_form_value}" /> px.
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_PRODUCTS_PER_PAGE_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			{else}
				<input style="width:250px" type="file" name="default_picture" value="{$default_picture|str_form_value}" />
			{/if}
			</td>
   	 	</tr>
	...
	{/if}
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_CONFIGURED_PROMOTIONS} <a href="{$promotions_href|escape:'html'}">{$promotions_href}</a>.</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" maxlength="2" size="3" name="pays_exoneration_tva" value="{$pays_exoneration_tva|str_form_value}" /> {$STR_ADMIN_SITES_NO_VAT_FOR_INTRACOM_FOREIGNERS_LOCAL_COUNTRY_SHORT_EXPLAIN}
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_NO_VAT_FOR_INTRACOM_FOREIGNERS_LOCAL_COUNTRY_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_BILLING_NUMBER_FORMAT_EXPLAIN}</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_REQUEST_FOR_PROPOSAL_VALIDITY_DAYS_EXPLAIN}</div></td>
		</tr>
		<tr>
			<td class="bloc" colspan="2">{$STR_ADMIN_SITES_SMALL_ORDERS}</td>
		</tr>
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_SMALL_ORDERS_EXPLAIN}</div></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SMALL_ORDERS_LIMIT}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" name="small_order_overcost_limit" value="{$small_order_overcost_limit|str_form_value}" /> {$site_symbole} {$STR_TTC}</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SMALL_ORDERS_AMOUNT}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" name="small_order_overcost_amount" value="{$small_order_overcost_amount|str_form_value}" /> {$site_symbole} {$STR_TTC}</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SMALL_ORDERS_VAT}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" name="small_order_overcost_tva_percent" value="{$small_order_overcost_tva_percent|str_form_value}" /> %</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_MINIMUM_ORDER_AMOUNT_ALLOWED}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" name="minimal_amount_to_order" value="{$minimal_amount_to_order|str_form_value}" /> {$site_symbole} {$STR_TTC}</td>
		</tr>
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_MINIMUM_ORDER_AMOUNT_ALLOWED_EXPLAIN}</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_ORDERS_UPDATING_OLD_FORBIDDEN_IF_OLDER_THAN_DATE_EXPLAIN}</div></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_DELIVERY_COST_METHOD_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_DELIVERY_FRANCO_LIMIT}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" value="{$nb_product|str_form_value}" name="nb_product" /> {$STR_ADMIN_SITES_DELIVERY_FRANCO_LIMIT_PRODUCTS_IN_CART}</td>
		</tr>
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_DELIVERY_FRANCO_LIMIT_PRODUCTS_IN_CART_EXPLAIN}</div>
				<div class="global_help">{$STR_ADMIN_SITES_DELIVERY_FRANCO_LIMIT_EXPLAIN}{$STR_BEFORE_TWO_POINTS}: {foreach $zones as $z}<a href="{$z.href|escape:'html'}">{$z.nom}</a>{if !$z@last}, {/if}{foreachelse}<b><a href="{$zones_href|escape:'html'}">{$STR_ADMIN_SITES_DELIVERY_FRANCO_NO_ZONE}</a></b>{/foreach}.</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="radio" name="module_ecotaxe" value="1" {if $module_ecotaxe == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_ecotaxe" value="0" {if $module_ecotaxe == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
	...
	{if $is_fonctionsdevises}
		<tr>
			...
			<td>
				<input type="radio" name="module_devise" value="1" {if $module_devise == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_devise" value="0" {if $module_devise == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
	...
	{/if}
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_EMAIL_CONFIGURATION_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_SUPPORT_SENDER_NAME_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
			<td>{$STR_MODULE_WEBMAIL_ADMIN_ORDER_MANAGEMENT_EMAIL}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:250px" type="text" name="email_commande" value="{$email_commande|str_form_value}" /> {$STR_ADMIN_SITES_EMAIL_EMPTY_DEFAULT_EXPLAIN}</td>
		</tr>
		<tr>
			<td>{$STR_MODULE_WEBMAIL_ADMIN_CLIENT_SERVICE_EMAIL}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:250px" type="text" name="email_client" value="{$email_client|str_form_value}" /> {$STR_ADMIN_SITES_EMAIL_EMPTY_DEFAULT_EXPLAIN}</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<div class="global_help">{$STR_ADMIN_SITES_MODULES_POSITIONS_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
			<td colspan="2">
						...
						<div class="edit_module_attribut">
							<table>
								<tr>
									...
									<td>
										<input type="text" name="display_mode_{$m.id}" value="{$m.display_mode}" size="10" />
									</td>
								</tr>
								<tr>
									<td>{$STR_ADMIN_PLACE}{$STR_BEFORE_TWO_POINTS}:</td>
									<td>
										<input type="radio" name="module_{$m.id}" id="{$m.id}_left" value="left"{if $m.location == 'left'} checked="checked"{/if}{if $m.is_left_off} disabled="disabled"{/if} /> <label for="{$m.id}_left">{$STR_ADMIN_SITES_LEFT}</label>
										<input type="radio" name="module_{$m.id}" id="{$m.id}_right" value="right"{if $m.location == 'right'} checked="checked"{/if}{if $m.is_right_off} disabled="disabled"{/if} /> <label for="{$m.id}_right">{$STR_ADMIN_SITES_RIGHT}</label>
								...
								<tr>
									...
									<td>
										<input type="text" name="position_{$m.id}" value="{$m.position|str_form_value}" size="1" />
									</td>
								</tr>
							</table>
						</div>
		...
		<tr>
			...
			<td><input style="width:250px" type="text" name="email_paypal" value="{$email_paypal|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input style="width:250px" type="text" name="email_moneybookers" value="{$email_moneybookers|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_MONEYBOOKERS_SECRET_WORD}{$STR_BEFORE_TWO_POINTS}:<br />
			</td>
			<td><input style="width:250px" type="text" name="secret_word" value="{$secret_word|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
 		...
 		<tr>
			...
			<td><input style="width:50px" type="text" name="availability_of_carrier" value="{$availability_of_carrier|str_form_value}" /> jours</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2"><textarea name="tag_analytics" style="width:100%" rows="5" cols="54">{$tag_analytics}</textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_nuage" value="1" {if $module_nuage == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_nuage" value="0" {if $module_nuage == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_flash" id="module_flash1" value="1" {if $module_flash == 1} checked="checked"{/if} /><label for="module_flash1">{$STR_YES}</label>
				<input type="radio" name="module_flash" id="module_flash0" value="0" {if $module_flash == 0} checked="checked"{/if} /><label for="module_flash0">{$STR_NO}</label>
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_pub" value="1" {if $module_pub == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_pub" value="0" {if $module_pub == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_ROLLOVER_EXPLAIN}</div></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_ROLLOVER_DISPLAY}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_rollover" value="1" {if $module_rollover == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_rollover" value="0" {if $module_rollover == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_rss" value="1" {if $module_rss == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_rss" value="0" {if $module_rss == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_avis" value="1" {if $module_avis == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_avis" value="0" {if $module_avis == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_CAPTCHA_EXPLAIN}</div></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_CAPTCHA_DISPLAY_MODE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_captcha" value="1" {if $module_captcha == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_captcha" value="0" {if $module_captcha == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
...
{if	!empty($STR_ADMIN_SITES_PREVIOUS_NEXT_BUTTONS_ACTIVATION_EXPLAIN)}
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_PREVIOUS_NEXT_BUTTONS_ACTIVATION_EXPLAIN}</div></td>
		</tr>
{/if}
		<tr>
			<td>{$STR_ADMIN_SITES_PREVIOUS_NEXT_BUTTONS_DISPLAY}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_precedent_suivant" value="1" {if $module_precedent_suivant == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_precedent_suivant" value="0" {if $module_precedent_suivant == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
	...
	{if $is_stock_advanced_module_active}
		...
		<tr>
			...
			<td>
				<input type="radio" name="payment_status_decrement_stock" value="1,2,3"{if $payment_status_decrement_stock == '1,2,3'} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="payment_status_decrement_stock" value="2,3"{if $payment_status_decrement_stock == '2,3'} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_STOCKS_DECREMENT_BY_PAYMENT_STATUS_EXPLAIN}</div></td>
		</tr>
	{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
	...
	{/if}
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_cart_preservation" id="module_cart_preservation1" value="1" {if $module_cart_preservation == 1} checked="checked"{/if} /> <label for="module_cart_preservation1">{$STR_YES}</label>
				<input type="radio" name="module_cart_preservation" id="module_cart_preservation0" value="0" {if $module_cart_preservation == 0} checked="checked"{/if} /> <label for="module_cart_preservation0">{$STR_NO}</label>
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_RESELLER_MANAGE_EXPLAIN}</div>
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_retail" value="1" {if $module_retail == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_retail" value="0" {if $module_retail == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_affilie" value="1" {if $module_affilie == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_affilie" value="0" {if $module_affilie == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_AFFILIATION_COMMISSION}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" maxlength="2" type="text" name="commission_affilie" value="{$commission_affilie|str_form_value}" /> %</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_AFFILIATION_LOGO}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" type="text" name="logo_affiliation" value="{$logo_affiliation|str_form_value}" /></td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_lot" value="1" {if $module_lot == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_lot" value="0" {if $module_lot == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_parrain" value="1" {if $module_parrain == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_parrain" value="0" {if $module_parrain == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td style="width:40%">{$STR_ADMIN_SITES_SPONSOR_COMMISSION}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100px" maxlength="3" type="text" name="avoir" value="{$avoir|str_form_value}" /> {$site_symbole}</td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_cadeau" value="1" {if $module_cadeau == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_cadeau" value="0" {if $module_cadeau == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_faq" value="1" {if $module_faq == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_faq" value="0" {if $module_faq == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_url_rewriting" value="1" {if $module_url_rewriting == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_url_rewriting" value="0" {if $module_url_rewriting == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td colspan="2"><div class="global_help">{$STR_ADMIN_SITES_MICROBUSINESS_EXPLAIN}</div></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_entreprise" value="1" {if $module_entreprise == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_entreprise" value="0" {if $module_entreprise == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="googlefriendconnect" value="1" {if $googlefriendconnect == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="googlefriendconnect" value="0" {if $googlefriendconnect == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_GOOGLE_FRIENDS_CONNECT_SITE_ID}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="googlefriendconnect_site_id" value="{$googlefriendconnect_site_id|str_form_value}" /> </td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		<tr>
			...
			<td><input style="" type="text" name="twitter_consumer_key" value="{$twitter_consumer_key|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_TWITTER_CONSUMER_SECRET}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="twitter_consumer_secret" value="{$twitter_consumer_secret|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_TWITTER_OAUTH_CALLBACK}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="twitter_oauth_callback" value="{$twitter_oauth_callback|str_form_value}" /></td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
	...
	{if $is_fonctionsvacances}
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_vacances" value="1" {if $module_vacances == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_vacances" value="0" {if $module_vacances == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" value="{$l.module_vacances_value|str_form_value}" name="module_vacances_client_msg_{$l.lng}" id="module_vacances_client_msg_{$l.lng}" size="100" /></td>
		</tr>
		{/foreach}
	{else}
		<tr>
	...
	{/if}
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_forum" value="1" {if $module_forum == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_forum" value="0" {if $module_forum == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_giftlist" value="1" {if $module_giftlist == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_giftlist" value="0" {if $module_giftlist == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_socolissimo" value="1" {if $module_socolissimo == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_socolissimo" value="0" {if $module_socolissimo == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_FOID}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:200px" type="text" name="socolissimo_foid" value="{$socolissimo_foid|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_SHA1_KEY}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:200px" type="text" name="socolissimo_sha1_key" value="{$socolissimo_sha1_key|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_URL_KO}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="socolissimo_urlko" value="{$socolissimo_urlko|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_PREPARATIONTIME}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:30px" type="text" name="socolissimo_preparationtime" value="{$socolissimo_preparationtime|str_form_value}" /> {$STR_ADMIN_SITES_SO_COLISSIMO_PREPARATIONTIME_EXPLAIN}</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_FORWARDINGCHARGES}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:30px" type="text" name="socolissimo_forwardingcharges" value="{$socolissimo_forwardingcharges|str_form_value}" /> {$site_symbole} - {$STR_ADMIN_SITES_SO_COLISSIMO_FORWARDINGCHARGES_EXPLAIN}</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_FIRSTORDER}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:30px" type="text" name="socolissimo_firstorder" value="{$socolissimo_firstorder|str_form_value}" /> {$STR_ADMIN_SITES_SO_COLISSIMO_FIRSTORDER_EXPLAIN}</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SO_COLISSIMO_POINT_RELAIS}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:30px" type="text" name="socolissimo_pointrelais" value="{$socolissimo_pointrelais|str_form_value}" /> {$STR_ADMIN_SITES_SO_COLISSIMO_POINT_RELAIS_EXPLAIN}</td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="module_icirelais" value="1" {if $module_icirelais == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="module_icirelais" value="0" {if $module_icirelais == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		{else}
		<tr>
		...
		{if $is_fonctionstnt}
			<tr>
				<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
				<td>
					<input type="radio" name="module_tnt" value="1" {if $module_tnt == 1} checked="checked"{/if} /> {$STR_YES}
					<input type="radio" name="module_tnt" value="0" {if $module_tnt == 0} checked="checked"{/if} /> {$STR_NO}
				</td>
			</tr>
			<tr>
				<td>{$STR_ADMIN_SITES_TNT_USERNAME}{$STR_BEFORE_TWO_POINTS}:</td>
				<td><input style="width:100%" type="text" name="tnt_username" value="{$tnt_username|str_form_value}" /></td>
			</tr>
			<tr>
				<td>{$STR_ADMIN_SITES_TNT_PASSWORD}{$STR_BEFORE_TWO_POINTS}:</td>
				<td><input style="width:100%" type="text" name="tnt_password" value="{$tnt_password|str_form_value}" /></td>
			</tr>
			<tr>
				<td>{$STR_ADMIN_SITES_TNT_ACCOUNT_NUMBER}{$STR_BEFORE_TWO_POINTS}:</td>
				<td><input style="width:100%" type="text" name="tnt_account_number" value="{$tnt_account_number|str_form_value}" /></td>
			</tr>
			<tr>
				<td>{$STR_ADMIN_SITES_TNT_EXPEDITION_DELAY}{$STR_BEFORE_TWO_POINTS}:</td>
				<td><input style="width:100%" type="text" name="expedition_delay" value="{$expedition_delay|str_form_value}" /></td>
			</tr>
		{else}
			<tr>
				<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		<tr>
			...
			<td><input style="width:100%" type="text" name="sips" value="{$sips|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input style="width:100%" type="text" name="spplus" value="{$spplus|str_form_value}" /></td>
		</tr>
		{else}
		<tr>
		...
		<tr>
			...
			<td><input style="width:100%" type="text" name="paybox_site" value="{$paybox_site|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_PAYBOX_RANG}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="paybox_rang" value="{$paybox_rang|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_PAYBOX_ID}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="paybox_identifiant" value="{$paybox_identifiant|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input style="width:100%" type="text" name="systempay_cle_prod" value="{$systempay_cle_prod|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SYSTEMPAY_TEST}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="systempay_cle_test" value="{$systempay_cle_test|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SYSTEMPAY_ID}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="systempay_code_societe" value="{$systempay_code_societe|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SYSTEMPAY_OCCURENCES}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="systempay_payment_count" value="{$systempay_payment_count|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_SYSTEMPAY_DAYS_BETWEEN_OCCURENCES}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="width:100%" type="text" name="systempay_payment_period" value="{$systempay_payment_period|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input style="width:100%" type="text" name="fb_admins" value="{$fb_admins|str_form_value}" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td>{$STR_ADMIN_ACTIVATE}{$STR_BEFORE_TWO_POINTS}:</td>
			<td>
				<input type="radio" name="facebook_connect" value="1" {if $facebook_connect == 1} checked="checked"{/if} /> {$STR_YES}
				<input type="radio" name="facebook_connect" value="0" {if $facebook_connect == 0} checked="checked"{/if} /> {$STR_NO}
			</td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_FACEBOOK_APPID}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="fb_appid" value="{$fb_appid|str_form_value}" /> </td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_FACEBOOK_SECRET}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="fb_secret" value="{$fb_secret|str_form_value}" /></td>
		</tr>
		<tr>
			<td>{$STR_ADMIN_SITES_FACEBOOK_BASEURL}{$STR_BEFORE_TWO_POINTS}:</td>
			<td><input style="" type="text" name="fb_baseurl" value="{$fb_baseurl|str_form_value}" /></td>
		</tr>
		{else}
		<tr>
			<td colspan="2"><a href="https://www.peel.fr/utilisateurs/contact.php">{$STR_ADMIN_SITES_CONTACT_PEEL_TO_GET_MODULE}</a></td>
		...
		{/if}
		<tr>
			<td colspan="2" class="center"><input class="bouton" type="submit" value="{$titre_bouton|str_form_value}" /></td>
		</tr>
	</table>
</form>