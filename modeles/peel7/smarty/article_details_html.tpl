...
// +----------------------------------------------------------------------+
// $Id: article_details_html.tpl 44077 2015-02-17 10:20:38Z sdelaporte $
*}{if !$is_article}
	{$STR_NO_FIND_ART}
{else}
	...
	<div class="rub_content">
		...
		{if isset($main_image)}
			...
			{/if}
		{/if}
		{if isset($chapo)}<div style="text-align:justify;">{$chapo|html_entity_decode_if_needed|nl2br_if_needed}{/if}
