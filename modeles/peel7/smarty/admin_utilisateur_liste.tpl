...
// +----------------------------------------------------------------------+
// $Id: admin_utilisateur_liste.tpl 36232 2013-04-05 13:16:01Z gboussin $
			...
			<td style="width:70px">
				<table>
					<tr>
						...
						<td>
							<a {if !empty($res.etat)} onclick="return confirm('{$STR_ADMIN_UTILISATEURS_DEACTIVATE_USER}');"{/if} title="{$STR_ADMIN_UTILISATEURS_UPDATE_STATUS|str_form_value}" href="{$res.modif_etat_href|escape:'html'}"><img class="change_status" src="{$res.etat_src|escape:'html'}" alt="" /></a>
						</td>
					</tr>
				</table>
			</td>
