					...
					<div class="navbar-inner">
						<div class="container">
							<div class="navbar-header">
								...
								{/if}
								{if !empty($unread_messages_info)}<span class="glyphicon glyphicon-message header_user"></span>{$unread_messages_info}{/if}
								{$MODULES_HEADER}
								{$header_custom_html}
							</div>
						</div>
