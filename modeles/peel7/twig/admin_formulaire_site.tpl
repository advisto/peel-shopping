...
<a href="{{ membre_href|escape('html') }}">{{ STR_ADMIN_SITES_HTTPS_TEST }}</a></div>
	...
	{% endif %}
		...
		<tr>
			<td colspan="2">
				...
				<div class="global_help">{{ STR_ADMIN_SITES_DELIVERY_FRANCO_LIMIT_EXPLAIN }}{{ STR_BEFORE_TWO_POINTS }}: {% if zones %}{% for z in zones %}<a href="{{ z.href|escape('html') }}">{{ z.nom }}</a>{% if 0 %}, {% endif %}{% endfor %}{% else %}<b><a href="{{ zones_href|escape('html') }}">{{ STR_ADMIN_SITES_DELIVERY_FRANCO_NO_ZONE }}</a></b>{% endif %}.</div>
			</td>
		</tr>
		<tr>
	...
	{% endif %}
						...
						<div class="edit_module_attribut">
							<table>
								...
								<tr>
									...
									<td>
										<input type="radio" name="module_{{ m.id }}" id="{{ m.id }}_left" value="left"{% if m.location == 'left' %} checked="checked"{% endif %}{% if m.is_left_off %} disabled="disabled"{% endif %} /> <label for="{{ m.id }}_left">{{ STR_ADMIN_SITES_LEFT }}</label>
										<input type="radio" name="module_{{ m.id }}" id="{{ m.id }}_right" value="right"{% if m.location == 'right' %} checked="checked"{% endif %}{% if m.is_right_off %} disabled="disabled"{% endif %} /> <label for="{{ m.id }}_right">{{ STR_ADMIN_SITES_RIGHT }}</label>
		...
		<tr>
			<td>{{ STR_ADMIN_ACTIVATE }}{{ STR_BEFORE_TWO_POINTS }}:</td>
			<td>
				<input type="radio" name="module_flash" id="module_flash1" value="1" {% if module_flash == 1 %} checked="checked"{% endif %} /><label for="module_flash1">{{ STR_YES }}</label>
				<input type="radio" name="module_flash" id="module_flash0" value="0" {% if module_flash == 0 %} checked="checked"{% endif %} /><label for="module_flash0">{{ STR_NO }}</label>
			</td>
		</tr>
		{% else %}
		<tr>
	...
	{% endif %}
		...
		<tr>
			...
			<td>
				...
				<input type="radio" name="module_conditionnement" value="0" {% if module_conditionnement == 1 %} checked="checked"{% endif %} /> {{ STR_NO }}
			</td>
		</tr>
		{% else %}
		<tr>
		...
		<tr>
			...
			<td>
				...
				<input type="radio" name="sign_in_twitter" value="0" {% if sign_in_twitter == 1 %} checked="checked"{% endif %} /> {{ STR_NO }}
			</td>
		</tr>
		<tr>
