...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_modif_position.tpl 55332 2017-12-01 10:44:06Z sdelaporte $
...
{% for res in results %}
		{{ res.tr_rollover }}
			...
			<td class="center"><input type="text" class="form-control" name="position[]" size="2" value="{{ res.position|str_form_value }}" style="width:50px;" /></td>
		</tr>
{% endfor %}
