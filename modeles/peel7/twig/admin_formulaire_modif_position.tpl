...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_modif_position.tpl 39495 2014-01-14 11:08:09Z sdelaporte $
...
{% for res in results %}
		{{ res.tr_rollover }}
			...
			<td class="center"><input type="text" class="form-control" name="position[]" size="2" value="{{ res.position|str_form_value }}" /></td>
		</tr>
{% endfor %}
