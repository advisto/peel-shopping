...
// +----------------------------------------------------------------------+
// $Id: admin_liste_clients_par_produit.tpl 35064 2013-02-08 14:16:40Z gboussin $
#}<table class="main_table">
	<tr>
		<td class="entete">{{ STR_ADMIN_PRODUITS_ACHETES_LIST_TITLE }} {{ nom }}</td>
	</tr>
	<tr>
		<td>
			<table class="admin_liste_clients_par_produit">
				<tr>
