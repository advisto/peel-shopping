...
// +----------------------------------------------------------------------+
// $Id: installation_bdd.tpl 39495 2014-01-14 11:08:09Z sdelaporte $
#}
...
{{ confirm_message }}
<form class="entryform form-inline" role="form" action="choixbase.php" method="post">
	<table>
		<tr>
			<td colspan="2">
		...
		<tr>
			...
			<td>
				<input type="password" class="form-control" name="motdepasse" size="25" value="{{ motdepasse_value|str_form_value }}" />
			</td>
		</tr>
		<tr>
			<td colspan="2" class="center">
				<input style="clear: both; float: left;" type="submit" value="{{ STR_CONTINUE|str_form_value }}" class="btn btn-primary btn-large" />
			</td>
		</tr>
	</table>
</form>