...
// +----------------------------------------------------------------------+
// $Id: avis_formulaire.tpl 36927 2013-05-23 16:15:39Z gboussin $
...
<form class="entryform" method="post" action="{{ action|escape('html') }}">
	<table class="avis_formulaire">
		...
		<tr>
			...
			<td><input type="text" name="pseudo" value="{% if not (pseudo) %}{{ pseudo_ses }}{% else %}{{ pseudo|str_form_value }}{% endif %}" maxlength="50" /></td>
		</tr>
		<tr>
			<td class="top">
