...
// +----------------------------------------------------------------------+
// $Id: admin_utilisateur_form.tpl 39443 2014-01-06 16:44:24Z sdelaporte $
		...
		<tr>
			...
			<td>
				<select class="form-control" id="activity" name="activity">
					<option value="">{{ STR_CHOOSE }}...</option>
					<option value="punctual" {% if activity == "punctual" %} checked="checked"{% endif %}>{{ STR_PUNCTUAL }}</option>
					<option value="recurrent" {% if activity == "recurrent" %} checked="checked"{% endif %}>{{ STR_RECURRENT }}</option>
				</select>
			</td>
		</tr>
{% endif %}
