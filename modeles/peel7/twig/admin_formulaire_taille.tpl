...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_taille.tpl 35064 2013-02-08 14:16:40Z gboussin $
#}<form method="post" action="{{ action|escape('html') }}">
	...
	<table class="main_table">
		...
		<tr>
			...
			<td><select name="signe"><option value="+"{% if signe == "+" }} selected="selected"{% endif %}>+</option><option value="-"{% if signe == "-" }} selected="selected"{% endif %}>-</option></select></td></tr>
		<tr>
