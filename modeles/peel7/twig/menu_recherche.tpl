...
// +----------------------------------------------------------------------+
// $Id: menu_recherche.tpl 43037 2014-10-29 12:01:40Z sdelaporte $
	...
	<form class="entryform form-inline" role="form" method="get" action="{{ action|escape('html') }}" id="recherche">
		<fieldset>
			...
			<div id="search_wrapper" class="input-group">
				<input type="text" class="form-control" name="search" id="search" value="" placeholder="{{ STR_SEARCH|escape('html') }}" {% if add_webpage_microdata %} property="query-input"{% endif %}/>
