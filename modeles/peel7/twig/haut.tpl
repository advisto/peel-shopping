...
// +----------------------------------------------------------------------+
// $Id: haut.tpl 50572 2016-07-07 12:43:52Z sdelaporte $
#}<!DOCTYPE html>
	...
	<body vocab="http://schema.org/" typeof="WebPage">
		...
		<div id="total" class="clearfix page_{{ page_name }}">
			...
			<header id="main_header">
					...
					<div class="navbar-inner">
						<div class="container">
							<div class="navbar-header">
								...
								{% endif %}
								{% if unread_messages_info %}<span class="glyphicon glyphicon-message header_user"></span>{{ unread_messages_info }}{% endif %}
								{{ MODULES_HEADER }}
								{{ header_custom_html }}
							</div>
						</div>
				...
				<div class="container">{{ text_introduction_category }}</div>
			</header>
			<!-- Fin Header -->
