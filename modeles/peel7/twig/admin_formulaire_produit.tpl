...
// +----------------------------------------------------------------------+
// $Id: admin_formulaire_produit.tpl 39443 2014-01-06 16:44:24Z sdelaporte $
			...
			<td colspan="2">
				...
				<div class="full-width" style="border: 1px #000000 dotted; background-color: #FAFAFA; padding:5px">
					<table class="table admin_commande_details">
						...
						<tbody id="dynamic_order_lines">{% for o in produits_options %}<tr class="top" id="line{{ o.i }}">
									<td>
										<img src="{{ administrer_url }}/images/b_drop.png" alt="{{ STR_DELETE }}" onclick="if(bootbox.confirm('{{ STR_ADMIN_PRODUCT_ORDERED_DELETE_CONFIRM|filtre_javascript(true,true,false) }}', function(result) {if(result) {delete_products_list_line({{ o.i }}, true);} } ))return false;" title="{{ STR_ADMIN_PRODUCT_ORDERED_DELETE }}" style="cursor:pointer" />
