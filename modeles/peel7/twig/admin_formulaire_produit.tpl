...
#}<form class="entryform form-inline" role="form" method="post" action="{{ action|escape('html') }}" enctype="multipart/form-data">
	...
	<div class="center" style="padding:10px;">
				...
				//--><!]]></script>
				<p><input class="btn btn-primary" {%if !allow_products_without_category %} onclick="if (verif_form() == false) {% endif %} { return false; }}" type="submit" value="{{ normal_bouton|str_form_value }}" /></p>
	</div>
</form>