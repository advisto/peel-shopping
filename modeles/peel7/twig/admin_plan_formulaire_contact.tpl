...
// +----------------------------------------------------------------------+
// $Id: admin_plan_formulaire_contact.tpl 36927 2013-05-23 16:15:39Z gboussin $
#}<form method="post" action="{{ action|escape('html') }}" enctype="multipart/form-data">
	...
	<table class="full_width">
		...
		<tr>
			<td class="label" colspan="2">{{ STR_ADMIN_HEADER_HTML_TEXT }} {{ l.lng }}{{ STR_BEFORE_TWO_POINTS }}:</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><textarea style="width:76%; height:140px;" name="map_tag">{{ map_tag }}</textarea></td>
		</tr>
		<tr>
			<td colspan="2" class="center"><br /><input class="bouton" type="submit" value="{{ normal_bouton|str_form_value }}" /></td>
		</tr>
	</table>
</form>