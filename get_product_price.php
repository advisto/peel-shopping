...
// +----------------------------------------------------------------------+
// $Id: get_product_price.php 35064 2013-02-08 14:16:40Z gboussin $
...
$output = $product_object->get_final_price(get_current_user_promotion_percentage(), display_prices_with_taxes_active(), is_reseller_module_active() && is_reseller(), true, true, 1, true, true, true);
