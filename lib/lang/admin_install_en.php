...
// +----------------------------------------------------------------------+
// $Id: admin_install_en.php 39495 2014-01-14 11:08:09Z sdelaporte $
...
$GLOBALS["STR_ADMIN_INSTALL_DATABASE_INTRO_2"] = "We're going to ask you this different information.";
$GLOBALS["STR_ADMIN_INSTALL_DATABASE_INTRO_3"] = "You need to get from your hosting MySQL identifiers.";
$GLOBALS["STR_ADMIN_INSTALL_DATABASE_INTRO_4"] = "Avoid using root, and prefer a mysql password which are robust and different from your SSH password for more security";
$GLOBALS["STR_ADMIN_INSTALL_ERROR_CONNEXION"] = "Error! Please check your selected languages and your connection information to the database";
...
$GLOBALS["STR_ADMIN_INSTALL_URL_STORE"] = "Shop URL:";
