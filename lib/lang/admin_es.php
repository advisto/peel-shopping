...
// +----------------------------------------------------------------------+
// $Id: admin_es.php 35067 2013-02-08 14:21:55Z gboussin $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_ADMIN_ARTICLES_ALL"] = "Todos los elementos";
$GLOBALS["STR_ADMIN_ARTICLES_ARTICLES_LIST"] = "Lista de artículos";
$GLOBALS["STR_ADMIN_ARTICLES_CATEGORIE"] = "Item";
$GLOBALS["STR_ADMIN_ARTICLES_COMPLETE_TEXT"] = "Texto completo del artículo";
$GLOBALS["STR_ADMIN_ARTICLES_CREATE_CATEGORY_FIRST"] = "Primero debe crear un elemento";
$GLOBALS["STR_ADMIN_ARTICLES_ERR_CHOOSE_ONE_CATEGORIE"] = "Debe seleccionar al menos un tema de este artículo.";
...
$GLOBALS["STR_ADMIN_ARTICLES_FORM_ADD"] = "Añadir elemento";
$GLOBALS["STR_ADMIN_ARTICLES_FORM_MODIFY"] = "Modificar el artículo";
$GLOBALS["STR_ADMIN_ARTICLES_MSG_CREATED_OK"] = "El tema %s fue creado.";
$GLOBALS["STR_ADMIN_ARTICLES_MSG_DELETED"] = "El %s ha sido eliminada artículo.";
$GLOBALS["STR_ADMIN_ARTICLES_NOTHING_FOUND_FOR_LANG"] = "No hay elementos almacenados en la base de la lengua";
$GLOBALS["STR_ADMIN_ARTICLES_TITLE"] = "Administrar elementos";
...
$GLOBALS["STR_ADMIN_BEGIN_DATE"] = "Fecha de inicio (MM/DD/AAAA)";
...
$GLOBALS["STR_ADMIN_CATEGORIES_DELETE_CATEGORY"] = "Eliminar Categoría";
...
$GLOBALS["STR_ADMIN_CATEGORIES_DISCOUNT_APPLY_TO_SONS"] = "Aplicar a las categorías infantiles";
...
$GLOBALS["STR_ADMIN_CATEGORIES_TITLE"] = "Administrar categorías";
...
$GLOBALS["STR_ADMIN_CLICK_HERE"] = "Pulse aqui";
...
$GLOBALS["STR_ADMIN_COMMANDER_MSG_AVOIR_SENT_BY_EMAIL_OK"] = "El %s han sido asignados a la cuenta %s<br />Él fue enviado por correo electrónico.";
...
$GLOBALS["STR_ADMIN_COMMANDER_SEND_BY_EMAIL_CONFIRM"] = "¿Estás seguro que quieres enviar la solicitud de pago por correo electrónico?";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_DOWNLOAD_LINK"] = "Enviar correo electrónico para descargar";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_PDF_BILL_BY_EMAIL_CONFIRM"] = "¿Estás seguro que quieres enviar este proyecto de ley?";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_PDF_BILL_BY_EMAIL"] = "Enviar factura PDF al cliente por correo electrónico";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_PDF_PROFORMA_BY_EMAIL_CONFIRM"] = "¿Estás seguro que quieres enviar la factura pro forma?";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_PDF_PROFORMA_BY_EMAIL"] = "Enviar el PDF por correo electrónico proforma al cliente";
$GLOBALS["STR_ADMIN_COMMANDER_SEND_PDF_QUOTATION_BY_EMAIL_CONFIRM"] = "¿Estás seguro que quieres enviar esta cita?";
...
$GLOBALS["STR_ADMIN_COMMENTS"] = "Comentarios";
...
$GLOBALS["STR_ADMIN_CONTACT_PEEL_ADDRESS"] = "51 bd Strasbourg 75010 Paris / +33 (0)1 75 43 67 97";
...
$GLOBALS["STR_ADMIN_EMAIL_TEMPLATES_TAG_WWWROOT"] = "URL del sitio";
...
$GLOBALS["STR_ADMIN_END_DATE"] = "Fecha de término (DD/MM/AAAA)";
...
$GLOBALS["STR_ADMIN_FILE"] = "Archivo";
...
$GLOBALS["STR_ADMIN_HTML_PLACE_CONVERSION_PAGE"] = "Tag google conversión Esta ubicación se utiliza en el último paso de la orden.";
...
$GLOBALS["STR_ADMIN_IMAGE"] = "Imagen";
...
$GLOBALS["STR_ADMIN_INDEX_TITLE"] = "Administración {$GLOBALS['site']}";
...
$GLOBALS["STR_ADMIN_META_META_DELETED"] = "El %s ha sido eliminada meta.";
...
$GLOBALS["STR_ADMIN_MENU_MANAGE_TITLE"] = "Administración del sitio";
...
$GLOBALS["STR_ADMIN_MENU_MANAGE_PAYMENT"] = "El pago";
...
$GLOBALS["STR_ADMIN_MENU_PRODUCTS_CATEGORIES_LIST"] = "Lista de categoría";
$GLOBALS["STR_ADMIN_MENU_PRODUCTS_CATEGORY_ADD"] = "Añadir categoría";
...
$GLOBALS["STR_ADMIN_MENU_SALES_SALES_TITLE"] = "Ventas y Contabilidad";
...
$GLOBALS["STR_ADMIN_MENU_CONTENT_ARTICLES_HEADER"] = "ARTÍCULOS / CATEGORÍAS";
$GLOBALS["STR_ADMIN_MENU_CONTENT_ARTICLES_LIST"] = "lista";
$GLOBALS["STR_ADMIN_MENU_CONTENT_ARTICLE_ADD"] = "Agregar elementos";
$GLOBALS["STR_ADMIN_MENU_CONTENT_CATEGORIES_LIST"] = "Lista de artículos";
$GLOBALS["STR_ADMIN_MENU_CONTENT_CATEGORY_ADD"] = "Agregar elementos";
...
$GLOBALS["STR_ADMIN_MENU_CONTENT_PARTNERS_CATEGORIES"] = "Gestión de socio de categoría";
...
$GLOBALS["STR_ADMIN_MENU_MODERATION_CATEGORIES"] = "Categorias management";
$GLOBALS["STR_ADMIN_MENU_MODERATION_CATEGORY_ADD"] = "Crear categoría";
...
$GLOBALS["STR_ADMIN_NEWSLETTERS_WARNING"] = "Advertencia:. La elaboración de un boletín HTML requiere un gran cuidado para que sea compatible con todas las plataformas de correos electrónicos Debe realizar pruebas de los elementos: el uso de estándar del editor de texto FCKEditor a continuación no debe dar la ilusión de un diseño simple que haría a continuación las principales cuestiones de compatibilidad cuando se juega por los usuarios. <a href=\"https://www.peel.fr/\" class=\"normal\" onclick=\"return (window.open (this.href) falso: true)\"> Para obtener ayuda con la implementación de HTML compatible, puede comunicarse con el PEEL 01 75 43 67 97</a>";
...
$GLOBALS["STR_ADMIN_PAYS_LIST_EXPLAIN"] = "Aquí está la tabla que muestra el <br /> país Usted puede agregar, editar o eliminar un país. El orden del país es manejable moviendo la línea de un país a la posición deseada.";
...
$GLOBALS["STR_ADMIN_PRODUCT_ORDERED_DELETE_CONFIRM"] = "¿Está seguro que desea eliminar este producto de mi pedido \ nEste borrará después definitivo en Guardar cambios en la parte inferior de la página?";
...
$GLOBALS["STR_ADMIN_PRODUITS_ACHETES_ERR_NO_TITLE"] = "Debe introducir un nombre de campo.";
...
$GLOBALS["STR_ADMIN_PRODUITS_ACHETES_MSG_CREATED_OK"] = "El elemento <b> %s</b> se ha creado.";
$GLOBALS["STR_ADMIN_PRODUITS_ACHETES_MSG_UPDATED_OK"] = "Los cambios en s elemento %se ha tenido en cuenta.";
...
$GLOBALS["STR_ADMIN_PRODUITS_BEST_SELLERS"] = "Mostrar en el título \"vendidos\"";
...
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_FLASH"] = "Mostrar en la sección Flash";
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_GIFT"] = "Este producto es un regalo";
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_HOME"] = "Mostrar página principal y bajo el título \"Nuestra selección\"";
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_NEW"] = "Mostrar en el título \"nuevo\"";
...
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_PROMOTIONS"] = "Mostrar en el título \"especial\"";
$GLOBALS["STR_ADMIN_PRODUITS_IS_ON_ROLLOVER"] = "Mostrar en el bloque \"En un\"";
$GLOBALS["STR_ADMIN_PRODUITS_IS_PRODUCT_IN"] = "El producto se encuentra en el";
...
$GLOBALS["STR_ADMIN_PRODUITS_NO_CATEGORY_RELATED"] = "SIN FAMILIA CONECTADO";
...
$GLOBALS["STR_ADMIN_RUBRIQUE"] = "Item";
$GLOBALS["STR_ADMIN_RUBRIQUES_ADD_ARTICLE"] = "Añadir elemento";
$GLOBALS["STR_ADMIN_RUBRIQUES_ADD_SUBCATEGORY"] = "Añadir un subtítulo";
$GLOBALS["STR_ADMIN_RUBRIQUES_ADD"] = "Añadir una sección";
$GLOBALS["STR_ADMIN_RUBRIQUES_ALL"] = "Todos los elementos";
$GLOBALS["STR_ADMIN_RUBRIQUES_CREATE"] = "Agregar este artículo";
$GLOBALS["STR_ADMIN_RUBRIQUES_DELETE_CATEGORY"] = "Eliminar elemento";
$GLOBALS["STR_ADMIN_RUBRIQUES_DISPLAY_NO_SUMMARY"] = "No mostrar enlace a artículos en la página del tema";
$GLOBALS["STR_ADMIN_RUBRIQUES_DISPLAY_SUMMARIES"] = "Mostrar las tapas y enlaces a artículos en esta categoría";
$GLOBALS["STR_ADMIN_RUBRIQUES_ERR_NOT_FOUND"] = "El elemento no se encontró.";
$GLOBALS["STR_ADMIN_RUBRIQUES_LIST_TITLE"] = "Lista de los campos";
$GLOBALS["STR_ADMIN_RUBRIQUES_MSG_CREATED_OK"] = "El %s artículo ha sido eliminado todos los artículos y subtítulos fueron reasignados al tema más adelante.";
$GLOBALS["STR_ADMIN_RUBRIQUES_MSG_DELETED_OK"] = "El archivo <b> %s</b> ha sido eliminado del servidor.";
$GLOBALS["STR_ADMIN_RUBRIQUES_NONE_RELATED"] = "ITEM NO CONECTADO";
$GLOBALS["STR_ADMIN_RUBRIQUES_PARENT"] = "Tema principal";
$GLOBALS["STR_ADMIN_RUBRIQUES_POSITION_EXPLAIN"] = "La posición de campo corresponde con el orden de aparición del elemento en el menú.";
$GLOBALS["STR_ADMIN_RUBRIQUES_TITLE"] = "Administrar categorías";
$GLOBALS["STR_ADMIN_RUBRIQUES_UPDATE"] = "Editar sección";
...
$GLOBALS["STR_ADMIN_SITES_CATEGORIES_PROMOTION"] = "Ofrecimiento por categoría";
$GLOBALS["STR_ADMIN_SITES_CATEGORY_COUNT_GLOBAL"] = "Global (categoría y sus subcategorías)";
$GLOBALS["STR_ADMIN_SITES_CATEGORY_COUNT_INDIVIDUAL"] = "individuales (una clase)";
...
$GLOBALS["STR_ADMIN_SITES_CONFIGURED_PROMOTIONS"] = "Si se selecciona esta opción, sólo los productos \"flash ventas\" y productos en rebajas por marca o sus calificaciones se publicarán en la página";
...
$GLOBALS["STR_ADMIN_SITES_NO_VAT_FOR_INTRACOM_FOREIGNERS_LOCAL_COUNTRY_EXPLAIN"] = "Introduzca las dos letras que indican el país (FR Francia, por ejemplo) para aplicar la exención del IVA para los usuarios sin registro IVA país extranjero.<br />Por ejemplo: si escribe dos letras FR, a continuación, todos los clientes poner un N º de IVA a partir de otro código de país no pagan IVA.";
...
$GLOBALS["STR_ADMIN_SITES_ORDERS_UPDATING_OLD_FORBIDDEN_IF_OLDER_THAN_DATE"] = "Todos los pedidos antes de la fecha DD/MM/AAAA";
...
$GLOBALS["STR_ADMIN_STATUT_PAIEMENT_MSG_UPDATED_OK"] = "Cambia el estado de pago %s han sido tenidos en cuenta.";
...
$GLOBALS["STR_ADMIN_TVA_CREATE"] = "Añadir una tasa de impuestos";
...
$GLOBALS["STR_ADMIN_TVA_FORM_TITLE"] = "Agregar o editar una tasa de impuestos";
$GLOBALS["STR_ADMIN_TVA_MSG_CREATED_OK"] = "La tasa del IVA se ha añadido.";
...
$GLOBALS["STR_ADMIN_UTILISATEURS_MSG_CREATED_OK"] = "El usuario <b>%s</b> se ha creado con la contraseña: <b>%s</b>";
...
$GLOBALS["STR_ADMIN_UTILISATEURS_PROJECT_DATE_FORECASTED"] = "Fecha de realización del proyecto considerado (DD/MM/AAAA)";
...
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_MSG_CREATED_OK"] = "atributo <b>%s</b> se ha creado.";
...
$GLOBALS["STR_MODULE_BANNER_ADMIN_END_PUBLICATION_DATE"] = "fecha final de publicación (DD/MM/AAAA)";
...
$GLOBALS["STR_MODULE_BANNER_ADMIN_POSITION_EXPLAIN"] = "La posición de definir un orden de las banderas en una lista de anuncios (en orden ascendente).";
...
$GLOBALS["STR_MODULE_BANNER_ADMIN_START_PUBLICATION_DATE"] = "Fecha de publicación (DD/MM/AAAA)";
...
$GLOBALS["STR_MODULE_BUTTERFLIVE_WELCOME_EXPLAIN_ACTIVATE"] = "Para permitir el seguimiento de visitantes y chat, debes registrarte para Butterflive luego descargar la consola de supervisión. ¡El registro es totalmente gratuito. A continuación, tendrá la oportunidad de suscribirse a Butterflive tener características exclusivas: <ul> <li> varios concejales simultáneo</li> Gestión de varios sitios web</li> Resultado adaptado a la Cesta visitante.</li></ul> ";
...
$GLOBALS["STR_MODULE_COMMERCIAL_ADMIN_CONTACT_TITLE"] = "Quiero contacto nuevamente con %s (DD/MM/AAAA)";
...
$GLOBALS["STR_MODULE_PARTENAIRES_MSG_CATEGORY_DELETED_OK"] = "Clase ha sido eliminada.";
...
$GLOBALS["STR_MODULE_WEBMAIL_ADMIN_EMAIL_EXPLAIN"] = "Estas direcciones de correo electrónico se configura en la configuración del sitio, bajo el título \" Administración de mensajes de correo electrónico \".";
...
$GLOBALS["STR_ADMIN_TYPES_EXPLAIN"] = "Puede establecer esta página los nombres de los modos de prestación Estos modos de entrega se unirá a las tarifas de envío..";
