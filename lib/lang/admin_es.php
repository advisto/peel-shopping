...
// +----------------------------------------------------------------------+
// $Id: admin_es.php 66961 2021-05-24 13:26:45Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_ADMIN_ALL_ZONES"] = "Todas las areas";
$GLOBALS["STR_ADMIN_ALL"] = "Todos";
$GLOBALS["STR_ADMIN_ALL_SITES"] = "Todos los sitios";
$GLOBALS["STR_ADMIN_ALL_STATUS_DELIVERY"] = "Todos los estados de entrega";
$GLOBALS["STR_ADMIN_ANY"] = "Lo que sea";
$GLOBALS["STR_ADMIN_APPLY_CHANGES"] = "¿Estás seguro de que quieres hacer los cambios?";
...
$GLOBALS["STR_ADMIN_ASSIGN"] = "asignar";
$GLOBALS["STR_ADMIN_ASSIGN_UNASSIGN_USERS_DO_NOT_HAVE_GROUP"] = "Asignar o anular la asignación de usuarios que no tienen un grupo";
...
$GLOBALS["STR_ADMIN_BRANDS_TO_EXCLUDE"] = "Administrar marcas negativas";
...
$GLOBALS["STR_ADMIN_CATEGORIES_LOT_PRICE_HANDLE_EXPLAIN"] = "Podrá definir diferentes precios según las cantidades cuando ya hayas creado esta categoría y la edites";
...
$GLOBALS["STR_ADMIN_CHECK_DATA"] = "Verificación de anomalías antes de la importación";
$GLOBALS["STR_ADMIN_CHECK_DATA_BEFORE_IMPORT"] = "Corrija las anomalías a continuación para que luego pueda importar sus datos";
...
$GLOBALS["STR_ADMIN_COMMANDER_QUOTE_CREATE_OR_UPDATE_TITLE"] = "Crear o modificar una cotización";
...
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CHANGED_ACCEPTED"] = "Cambiado a Aceptado el";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CHANGED_REFUSED"] = "Cambiado a Rechazado en";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CONFIRM_ACCEPT"] = "¿Seguro que quiere aceptar la propuesta?";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CONFIRM_REFUSE"] = "¿Está seguro de que deseas rechazar la oferta?";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CREATED_BY"] = "Creado por";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_CREATED_ON"] = "Creado el";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_DATE_INSERE_END"] = "Fecha de creación fin";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_DATE_INSERE_START"] = "Fecha de creación inicio";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_DATE_MAJ_END"] = "Fecha final de aceptación";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_DATE_MAJ_START"] = "Fecha de inicio de aceptación";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_EXPLAIN"] = "Aquí se muestra la lista de propuestas de los representantes de ventas en descripciones (categorías y marcas)";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_FORM_MODIFY"] = "Modificar la propuesta para la categoría o marca.";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_FORM_MODIFY_AFTER"] = "Propuesta (no modificable)";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_FORM_MODIFY_BEFORE"] = "Descripción actual (para modificar)";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_FORM_SUBMIT_BUTTON"] = "Validar la modificación de la descripción ";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_KEYWORD"] = "Palabra clave";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_NOT_FOUND"] = "No se encontró ninguna propuesta.";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_STATUT"] = "Estado";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_STATUT_MSG_UPDATED_OK"] = "Se han tenido en cuenta los cambios realizados en el estado de la propuesta.";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_TABLE"] = "Gestionar las propuestas";
$GLOBALS["STR_ADMIN_DESCRIPTION_DETAILS_TITLE"] = "Lista de propuestas";
...
$GLOBALS["STR_ADMIN_EXPORT_PDF"] = "Exportación PDF";
$GLOBALS["STR_ADMIN_EXPORT_PRICES_DISABLE"] = "No los precios de exportación (para la exportación CSV)";
$GLOBALS["STR_ADMIN_EXPORT_PAGE_BREAK_EACH_GROUP"] = "Salto de página a cada grupo para imprimir";
$GLOBALS["STR_ADMIN_EXPORT_PRODUCTS_CHOOSE_EXPORT_CRITERIA"] = "Elegir los criterios de exportación";
$GLOBALS["STR_ADMIN_EXPORT_SHOW_DETAILS"] = "Mostrar líneas de detalle";
$GLOBALS["STR_ADMIN_EXPORT_SKIP_EMPTY_TOTALS"] = "Eliminar filas con total cero";
...
$GLOBALS["STR_ADMIN_EXPORT_COLUMNS"] = "Elección y orden de las columnas";
...
$GLOBALS["STR_ADMIN_EXPORT_SEPARATOR_EXPLAIN"] = "indicar \\t para la tabulación";
$GLOBALS["STR_ADMIN_EXPORT_TYPE"] = "Tipo de datos para exportar";
...
$GLOBALS["STR_ADMIN_IMPORT_CORRESPONDANCE_EXPLANATION"] = "Una vez que se ha elegido el tipo de datos a importar y se ha completado la tabla de correspondencia, haga clic en el botón 'Validar' en la parte inferior de la página para realizar la importación de datos";
$GLOBALS["STR_ADMIN_IMPORT_ERR_COLUMN_NOT_FOUND"] = "La columna elegida no se encuentra en el archivo: %s";
...
$GLOBALS["STR_ADMIN_IMPORT_ERR_COLUMN_FILE_STRUCTURE"] = "La estructura del archivo CSV parece ser problemática en términos del número de fila, columna %s";
$GLOBALS["STR_ADMIN_IMPORT_ERR_FIELDS_NOT_CHOSEN"] = "Usted debe marcar al menos una caja<br />Importación detenido.";
$GLOBALS["STR_ADMIN_IMPORT_ERR_FILE_NOT_FOUND"] = "Archivo no encontrado<br />Importación detenido!";
$GLOBALS["STR_ADMIN_IMPORT_ERR_INCOHERENT_COLUMNS"] = "Problema al importar: hay varias columnas \"%s\" en el archivo de origen - no importación";
$GLOBALS["STR_ADMIN_IMPORT_ERR_REFERENCE_DOES_NOT_EXIST"] = "La categoría de referencia %s no existe";
$GLOBALS["STR_ADMIN_IMPORT_ERR_TYPE_NOT_CHOSEN"] = "El tipo de importación no se ha seleccionado<br />Importación detenido.";
$GLOBALS["STR_ADMIN_IMPORT_EXPLAIN"] = "- La primera línea debe contener los encabezados de columna<br />- No debe haber ninguna fórmula en el archivo CSV<br />- El separador decimal debe ser el punto de<br />la coma - El separador usado en el expediente, ficha, punto y coma o coma sólo debe indicar un cambio en<br />columna - El archivo no se puede abrir la aplicación para poder descargar <br /> - Las fotos corresponden a los productos que deben gestionar por separado a la FTP en el directorio {$GLOBALS['uploaddir']} /<br />- <b> Antes de importar categorías identificadores, hacen que ya ha creado estas categorías con la administración</b><br />";
$GLOBALS["STR_ADMIN_IMPORT_FILE_ENCODING"] = "Codificación de datos";
$GLOBALS["STR_ADMIN_IMPORT_FILE_EXAMPLE"] = "Ejemplo de archivo";
$GLOBALS["STR_ADMIN_IMPORT_FILE_FORMAT_EXPLAIN"] = "columnas separadoras permitidos: punto y coma, coma, tabulador, ...";
$GLOBALS["STR_ADMIN_IMPORT_FILE_FORMAT"] = "El archivo imperativo Formato";
$GLOBALS["STR_ADMIN_IMPORT_FILE_NAME"] = "Archivo de datos";
$GLOBALS["STR_ADMIN_IMPORT_FORM_TITLE"] = "PRODUCTOS DE IMPORTACIÓN DE ARCHIVOS";
$GLOBALS["STR_ADMIN_IMPORT_IMPORT_ALL_FIELDS"] = "Importar todos los campos que se encuentran en el archivo";
$GLOBALS["STR_ADMIN_IMPORT_IMPORT_MODE"] = "Seleccione el modo de importación";
$GLOBALS["STR_ADMIN_IMPORT_IMPORT_SELECTED_FIELDS"] = "Importar sólo los campos seleccionados abajo";
$GLOBALS["STR_ADMIN_IMPORT_MSG_ATTRIBUTE_CREATED"] = "Crear atributo %s - creado con id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_BRAND_CREATED"] = "Creación del %s - creado con id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_CATEGORY_CREATED"] = "Crear categoría %s - creado con id=%s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_IMPORTATION_OK"] = "El número de productos importados con éxito: %s en total, incluyendo: %s cambio, %s sin modificar, %s creado<br />Asociación entre productos y categorías: %s creado.";
$GLOBALS["STR_ADMIN_IMPORT_MSG_LINE_CREATED"] = "línea Import %s - producto creado con id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_LINE_UPDATED"] = "línea %s Import - producto actualizado con el id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_OPTION_CREATED"] = "Crear la opción %s - creado con id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_TARIF_CREATED"] = "Creación precio de descuento (%s) prix_revendeur (%s) y la cantidad (%s) para el producto id = %s";
$GLOBALS["STR_ADMIN_IMPORT_MSG_TARIF_UPDATED"] = "Actualizar Ventajas económicas (%s) prix_revendeur (%s) y la cantidad (%s) para el producto id = %s";
...
$GLOBALS["STR_ADMIN_IMPORT_SAVE_IMPORT_PARAMS"] = "Guardar parámetros de importación";
$GLOBALS["STR_ADMIN_IMPORT_STATUS"] = "Fin de importación";
...
$GLOBALS["STR_ADMIN_MENU_PRODUCTS_PROPOSITIONS_LIST"] = "Lista de propuestas";
...
$GLOBALS["STR_ADMIN_NEWSLETTERS_CHOOSE_TEMPLATE_INFO"] = "Para personalizar su boletín de noticias, usted puede crear una plantilla de email que contiene la etiqueta [NEWSLETTER]. Esta etiqueta será reemplazado por el contenido conjunto en esta página. <br /> Si desea añadir productos a su boletín, deberá añadir la etiqueta [PRODUCT_LIST] en la que desea que aparezcan los productos. Los productos que se muestran se pueden seleccionar desde el campo de búsqueda en la parte inferior de esta página";
$GLOBALS["STR_ADMIN_NEWSLETTERS_CREATE"] = "Añadir un boletín de noticias";
$GLOBALS["STR_ADMIN_NEWSLETTERS_SEND_CONFIRM"] = "¿Estás seguro de que deseas enviar este boletín?";
...
$GLOBALS["STR_ADMIN_PAIEMENT_TECHNICAL_CODE_DEFAULT_EXPLAIN"] = "Lista de códigos de defecto técnico<br />cheque: cheque<br />Paypal: PayPal<br />Transferencia bancaria:<br />transferencia";
...
$GLOBALS["STR_ADMIN_PRODUITS_CHOOSE_REFERENCE_PACKS"] = "ELIGE LOS PACKS PRODUCTOS REFERENCIAS";
...
$GLOBALS["STR_ADMIN_PRODUITS_ESTIMATE_PRICE"] = "Precio estimado";
...
$GLOBALS["STR_ADMIN_PRODUCTS_QUOTE"] = "Producto fuera de formato";
...
$GLOBALS["STR_ADMIN_SITES_TNT_EXTRA_COST"] = "Costo adicional";
$GLOBALS["STR_ADMIN_SITES_TNT_TRESHOLD_LIMIT"] = "Límite que no debe superarse";
...
$GLOBALS["STR_ADMIN_TEXT_HEADER_FOR_REPORT"] = "Texto en la parte superior del informe";
$GLOBALS["STR_ADMIN_TEXT_FOOTER_FOR_REPORT"] = "Texto al final del informe";
...
$GLOBALS["STR_ADMIN_UPDATE_WARNING"] = "¿Estás seguro de que quieres editar?";
...
$GLOBALS["STR_ADMIN_UTILISATEURS_CODE_PROMO_CHOOSE_EXPLAIN"] = "Elige el código de promoción";
$GLOBALS["STR_ADMIN_UTILISATEURS_CODE_PROMO_SEND"] = "Enviar los usuarios de este código promocional Las marcadas arriba";
$GLOBALS["STR_ADMIN_UTILISATEURS_CODE_PROMO_SEND_TO_ALL"] = "Envía este código promocional a todos";
$GLOBALS["STR_ADMIN_UTILISATEURS_CODE_PROMO_SEND_CHECKED_USERS"] = "Enviar este código promocional a los usuarios seleccionados anteriormente";
$GLOBALS["STR_ADMIN_UTILISATEURS_GROUP_SELECT_EXPLAIN"] = "Si se elige un grupo, los destinatarios del envío de correos serán solo miembros del grupo seleccionado (en el caso de enviar a todos)";
$GLOBALS["STR_ADMIN_UTILISATEURS_NEWSLETTER_SEND_TO_BEST_CLIENTS"] = "Enviar un boletín a los mejores clientes";
$GLOBALS["STR_ADMIN_UTILISATEURS_NEWSLETTER_CHOOSE_NEWSLETTER"] = "Elija el boletín";
$GLOBALS["STR_ADMIN_UTILISATEURS_NEWSLETTER_SEND_CHECKED_USERS"] = "Enviar el boletín a los usuarios seleccionados anteriormente";
$GLOBALS["STR_ADMIN_UTILISATEURS_NEWSLETTER_SEND_TO_ALL"] = "Envíe el boletín a todos";
$GLOBALS["STR_ADMIN_UTILISATEURS_COMMERCIAL_CHECKBOX"] = "Seleccione esta casilla para suscribirse al usuario comercial";
$GLOBALS["STR_ADMIN_UTILISATEURS_USERS_GROUP"] = "Perfiles de usuario";
...
$GLOBALS["STR_ADMIN_UTILISATEURS_NO_FACT_FOUND"] = "No hay facturas registradas para este cliente.";
...
$GLOBALS["STR_ADMIN_ZONES_APPLY_FRANCO_MODE_ON"] = "Exención de franqueo aplica";
$GLOBALS["STR_ADMIN_ZONES_APPLY_FRANCO_MODE_NO"] = "Sin exención";
$GLOBALS["STR_ADMIN_ZONES_APPLY_MODE_ON_AMOUNT"] = "En la cantidad";
$GLOBALS["STR_ADMIN_ZONES_APPLY_MODE_ON_WEIGHT"] = "En el peso";
...
$GLOBALS["STR_ADMIN_ZONES_FRANCO_LIMIT_WEIGHT"] = "Peso total a partir del cual se aplica la exención de franqueo";
...
$GLOBALS["STR_MODULE_ATTRIBUTS_ASSOCIATION_ALREADY_EXIST"] = "Asociación entre el atributo %s y el producto %s ya existente";
$GLOBALS["STR_MODULE_ATTRIBUTS_ASSOCIATION_DELETED"] =  "Eliminación de la asociación entre el atributo %s y el producto %s realizado";
$GLOBALS["STR_MODULE_ATTRIBUTS_ASSOCIATION_OK"] =  "Asociación entre el atributo %s y el producto %s realizado";
...
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_ATTRIBUTES_CHECKED_IN_CATEGORY_PRODUCTS"] = "los atributos comprobados para los productos de la categoría";
...
$GLOBALS["STR_MODULE_BANNER_ADMIN_ON_PRODUCT_DETAILS"] = "Detalles de producto";
...
$GLOBALS["STR_MODULE_PREMIUM_ADMIN_DELIVERY_DELAY_SEVEN_DAYS"] = "Muestre la mención \"Artículo disponible en 7 días\"";
...
$GLOBALS["STR_ADMIN_TYPES_LINK_TO_DPD"] = "Enlace a este modo de entrega a DPD";
$GLOBALS["STR_ADMIN_TYPES_LINK_TO_ICIRELAIS"] = "Enlace a este modo de entrega a ICI relais";
$GLOBALS["STR_ADMIN_TYPES_LINK_TO_MONDIAL_RELAY"] = "Conecte este método de entrega a Mondial Relay";
...
$GLOBALS["STR_ADMIN_ASSOCIATED"] = "Asociar";
$GLOBALS["STR_ADMIN_DISASSOCIATED"] = "Desasociar";

$GLOBALS["STR_PRICE_ESTIMATE"] = "Precio estimado";

$GLOBALS['STR_ADMIN_HTML_END_PROCESS_ORDER'] = "Fin del proceso de pedido corto";
$GLOBALS['STR_ADMIN_HTML_HEADER_LOGO_SIGNATURE'] = "Logotipo de la firma";
$GLOBALS['STR_MODULE_PREMIUM_ADMIN_DELIVERY_SCALE_STOCK'] = "Dias ? ¿Semana? o mes?";
$GLOBALS['STR_ADMIN_HTML_CONTENT_MAIN_CONTENT'] = "Inicio HTML area TOP";
$GLOBALS['STR_ADMIN_HTML_PLACE_FOOTER_FULL_CUSTOM_HTML'] = "Pie de página HTML completo";
...
$GLOBALS["STR_ADMIN_CARROUSEL_CATEGORY"] = "Carrusel de categorías";
$GLOBALS["STR_ADMIN_ACTIF"] = "Activo";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_PRODUCTS_ATTRIBUTS_PRICE"] = "Administrar los precios de los atributos asociados al producto.";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_BACK_TO_LIST_ATTRIBUTS"] = "Regresar a la lista de atributos";

$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_MOTTE"] = "Terrón";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_BAC"] = "Bandeja";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_NOT_CONDITION"] = "Sin condicion";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_NEW_LIGNE"] = "Nueva línea";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_NEW_GROUP"] = "Nuevo grupo";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_GROUP"] = "Grupo";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_STATUS"] = "Estado";
$GLOBALS["STR_MODULE_ATTRIBUTS_ADMIN_CONDIT"] = "embalaje";
$GLOBALS["STR_ADMIN_HEADING"] = "en cabeza";
$GLOBALS["STR_ADMIN_PRIMARY_KEY_MANDATORY"] = "Se debe ingresar la clave primaria \"%s\".";
$GLOBALS["STR_ADMIN_FIELD_VALUE_MANDATORY"] = "El valor del campo \"%s\" debe completarse para una inserción.";
$GLOBALS["STR_ADMIN_CODE_MAX_CHAR_REACHED"] = "El código \"%s\" tiene %s caracteres en lugar del máximo %s caracteres permitido.";
$GLOBALS["STR_ADMIN_VALUE_NOT_EXIST_IN_TABLE"] = "El valor \"%s\" no existe en la tabla \"%s\" para el campo \"%s\".";
$GLOBALS["STR_ADMIN_COLUMN_CONTAINS_CHOICE"] = "La columna \"%s\" debe contener: %s";
$GLOBALS["STR_ADMIN_FIELD_UNIQUE"] = "El valor del campo \"%s\" debe ser único.";
$GLOBALS["STR_ADMIN_IMPORT_USER_END"] = "Fin de la importación del usuario: %s insertado, %s MAJ";
$GLOBALS["STR_ADMIN_IMPORT_FILE_END"] = "Fin de la importación del archivo: %s líneas insertadas, %s MAJ";
$GLOBALS["STR_ADMIN_INSERT_VALUE_FORBIDDEN"] = "Prohibida la inserción en la tabla %s.";
$GLOBALS["STR_ADMIN_NO_PROBLEM_OCCURED"] = "No se encontró ninguna anomalía";
$GLOBALS["STR_ADMIN_LINE"] = "Línea";
$GLOBALS["STR_ADMIN_SIMULATION"] = "Simulación";
$GLOBALS["STR_ADMIN_CHOOSE_COLUMN"] = "Debes elegir columnas para exportar";
$GLOBALS["STR_ADMIN_PRODUCT_ID_MANDATORY_IN_URL"] = "Debe definir una identificación de producto en la URL";
$GLOBALS["STR_ADMIN_TOTAL_HT_ALL_INCLUDE"] = "TOTAL sin IVA todo incluido";
$GLOBALS["STR_ADMIN_TOTAL_TVA_ALL_INCLUDE"] = "IVA todo incluido";
$GLOBALS["STR_ADMIN_TOTAL_TTC_ALL_INCLUDE"] = "TOTAL impuestos incluidos";
...
$GLOBALS["STR_ADMIN_PRICE"] = "Precio";
$GLOBALS["STR_ADMIN_COLUMN_TTTLE_FIRST_LINE"] = "Coloque los títulos de las columnas en la primera fila (si está disponible para el tipo de exportación elegido)";
$GLOBALS["STR_ADMIN_ADD_FOOTER_FILE_EXPORT"] = "Coloque un pie de página que contenga los totales al final del archivo de exportación (la columna amount_ht debe estar presente en el archivo)";
$GLOBALS["STR_ADMIN_COLUMN_AVAILABLE"] = "Columnas disponibles";
$GLOBALS["STR_ADMIN_MOVE_COLUMN_WITH_DRAG_DROP_FOR_EXCLUDE"] = "Arrastre y suelte los nombres de columna EXCLUIDOS a continuación";
$GLOBALS["STR_ADMIN_GENERATE_FILE"] = "Columnas incluidas";
$GLOBALS["STR_ADMIN_FILE_COLUMN_EXPORTED"] = "Arrastre y suelte los nombres de columna deseados a continuación";
$GLOBALS["STR_ADMIN_SELECTED_COLUMN_FOR_EXPORT"] = "Después de elegir el tipo de datos anterior";
$GLOBALS["STR_ADMIN_SOURCE_FILE"] = "Archivo fuente";
$GLOBALS["STR_ADMIN_MOVE_COLUMN_WITH_DRAG_DROP"] = "Columnas para mover con arrastrar y soltar a la tabla de correspondencia";
$GLOBALS["STR_ADMIN_IMPORT_MANDATORY_FIELD_INFORMATION_MESSAGE"] = "* Campos obligatorios para inserciones: asociar con una columna o indicar un valor predeterminado &nbsp; &nbsp; ** Cave primaria";
$GLOBALS["STR_ADMIN_SITE_COLUMN_IN_DATABASE"] = "Columna %s en la base de datos";
$GLOBALS["STR_ADMIN_TYPE"] = "Tipo";
$GLOBALS["STR_ADMIN_IMPORTED_COLUMN"] = "Columna importada (arrastrar y soltar)";
$GLOBALS["STR_ADMIN_DEFAULT_VALUE"] = "Valor por defecto";
$GLOBALS["STR_ADMIN_CORRESPONDANCE_COLUMN_FILE_AND_SITE"] = "Después de elegir el tipo de datos a importar %s";
$GLOBALS["STR_ADMIN_SEND_EMAIL_TO_USERS"] = "Envía correos electrónicos a los usuarios";
$GLOBALS["STR_ADMIN_HTML_PRODUCT_PAGE_FOOTER"] = "Pie de página del producto";
$GLOBALS["STR_ADMIN_HTML_HOME_HEADER"] = "En el menú de la página de inicio ";
$GLOBALS["STR_ADMIN_SHOW_TAG_LIST_EXPLANATION"] = "Una etiqueta es un elemento que será reemplazado automáticamente por el valor correcto (asociado con el destinatario) al enviar el correo electrónico. Para agregar una etiqueta al texto del correo electrónico, puede hacer clic en ella.";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE'] = "Acción grupal sobre la selección";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_OUR_SELECTION'] = "Mostrar en la página de inicio y en la sección Nuestra selección";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_OFF_OUR_SELECTION'] = "No mostrar en la página de inicio y en la sección Nuestra selección";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_NEW'] = "Mostrar en la sección de noticias";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_OFF_NEW'] = "No mostrar en la sección de Noticias";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_PROMO'] = "Mostrar en la sección Promociones";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_OFF_PROMO'] = "No mostrar en la sección Promociones";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_BEST_SELLERS'] = "Mostrar en la sección de los más vendidos";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_OFF_BEST_SELLERS'] = "No mostrar en la sección de bestsellers";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_RECOMMENDED_PRODUCTS'] = "Ver en productos recomendados";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_TOP'] = "Mostrar en el bloque Destacado";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_ON_ETAT'] = "Poner en linea";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_OFF_ETAT'] = "Desconectar";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_SUPPR_PRODUCT'] = "Eliminar productos seleccionados";
$GLOBALS['STR_ADMIN_NO_UPDATE_VERSION'] = "Esta página no se utiliza para actualizar la base de datos de este sitio. Póngase en contacto con soporte";
$GLOBALS['STR_ADMIN_MODIFICATION_MULTIPLE_SUPPR_PRODUCT'] = "Eliminar productos seleccionados";
$GLOBALS['STR_CONTINUE_WITH_ERROR'] = "Forzar la importación solo de filas válidas";
$GLOBALS['STR_CONTINUE_WITH_ERROR_CONFIRM'] = "El archivo que desea importar tiene anomalías en algunas líneas. ¿Está seguro de que desea ignorar estas líneas e importar las otras líneas que son válidas?";
$GLOBALS['STR_ADMIN_LINE_WITH_ERROR_NOT_IMPORT'] = "Línea(s) con anomalía y por lo tanto no importada";
$GLOBALS["STR_ADMIN_MORE_INFOS"] = "Mostrar más información";
$GLOBALS["STR_ADMIN_LESS_INFOS"] = "Mostrar menos información";
$GLOBALS["STR_ADMIN_GENERAL"] = "General";
$GLOBALS["STR_ADMIN_CONTACT_DATE"] = "Fecha de contacto";
$GLOBALS["STR_ADMIN_CALL_AND_EVENT"] = "Llamada / Evento";
$GLOBALS["STR_ADDRESSES"] = "Direcciones";
$GLOBALS["STR_ADMIN_CLIENT_HISTORY"] = "Historial del cliente";
$GLOBALS["STR_ADMIN_CONTACT_PLANIFICATION"] = "Planificación de contactos";
$GLOBALS["STR_ADMIN_CLIENT_PAGE"] = "Tarjeta de cliente";
$GLOBALS["STR_ADMIN_CONTACT_AND_ACTION"] = "Contactos y acciones";
$GLOBALS["STR_ADMIN_CONNECTION_HISTORY"] = "Historial de conexiones";
