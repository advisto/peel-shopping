...
// +----------------------------------------------------------------------+
// $Id: eo.php 39443 2014-01-06 16:44:24Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_CGV_OK"] = "Mi prilegis la <a href=\"{$GLOBALS['wwwroot']}/cgv.php\" class=\"label\" onclick=\"return(window.open(this.href)?false:true);\">ĝeneralajn vendajn kondiĉojn</a> de la retejo {$GLOBALS['site']}, aktualajn, kaj mi aprobas ilin senrezerve.";
...
$GLOBALS["STR_MODULE_TELECHARGEMENT_RETURN_ACCUEIL_DOWNLOAD"] = "<a href=\"{$GLOBALS['wwwroot']}\" class=\"normal\"><b>Ĉi klaku</b></a> por reiri al Hejmpaĝo.";
...
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_NEW_SEARCH"] = "Krei novan avertilon.";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_SEARCH"] = "Krei avertilon";
$GLOBALS["STR_MODULE_USER_ALERTS_CANT_SAVE_MORE_SEARCH"] = "Ne eblas aldoni novan avertilon";
$GLOBALS["STR_MODULE_USER_ALERTS_NO_SEARCH_LIST"] = "Neniu avertilo savita";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_LIST"] = "Listo de viaj savitaj avertiloj";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_NAME"] = "Nomo de ĉi avertilo";
$GLOBALS["STR_MODULE_USER_ALERTS_MY_ALERTS"] = "Miaj avertiloj";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_ALERT"] = "Savi ĉi avertilon";
$GLOBALS["STR_MODULE_USER_ALERTS_SEE_ALERT_RESULTS"] = "Konsulti la resultojn de ĉi avertilo:";
...
$GLOBALS["STR_NO_FIND_ART"] = "<h1>Artikolo ne trovita</h1><blockquote class=\"normal\">Bedaŭrinde, la artikolo kiun vi serĉas ne estis trovita. Legu la <a href=\"{$GLOBALS['wwwroot']}/lire/\">ĝeneralajn informojn</a> por denove fari serĉon.</blockquote>";
$GLOBALS["STR_NO_FIND_PRODUCT"] = "<h1>Varo ne trovita</h1><blockquote class=\"normal\">Bedaŭrinde, la varo kiun vi serĉas ne estis trovita. Legu la <a href=\"{$GLOBALS['wwwroot']}/lire/\">katalogon</a> por denove fari serĉon.</blockquote>";
...
$GLOBALS["STR_SUGGEST"] = "Via kredito ebligas vin akiri pliajn varojn rilataj. <a href=\"achat/suggest.php\" class=\"label\">Ni proponas vin konsulti la sugest-liston por kompletigi vian aĉetadon</a>.";
