...
// +----------------------------------------------------------------------+
// $Id: database_email_template_text_fr.php 61970 2019-11-20 15:48:40Z sdelaporte $
...
Références de l'envoi : le n° de colis est [COLIS]. Pour La Poste, vous pouvez suivre l'acheminement de votre colis en cliquant sur le lien suivant : https://www.laposte.fr/particulier/outils/suivre-vos-envois
...
Cet email à pour but de vous sensibiliser à la sécurité de votre site PEEL pour mieux le protéger.",
  "signature" => "
