...
// +----------------------------------------------------------------------+
// $Id: database_email_template_name_ro.php 64741 2020-10-21 13:48:51Z sdelaporte $
...
$peel_email_template["name"] = array(
  ...
  "signature_externe" => "",
  "signature_support" => "",
  "download_product" => "Descărcaţi comanda dvs.",
  ...
  "admin_info_payment_credit_card_3_times" => "Comanda CB  în  trei exemplare în curs de înregistrare ",
  "send_client_order_html" => "Comanda dvs.  [ORDER_ID]  pe  [SITE] cu factura  HTML",
  ...
  "admin_login" => "Administrator info login",
  "signature" => "Semnare automată emailuri ",
  "cree_cheque_cadeau_client_type1" => "[FRIEND] vă oferă un cec cadou ( procentaj )",
  "warn_admin_user_subscription" => "Avertisment la înscrierea unui utilizator",
  "warn_admin_reve_subscription" => "",
  "email_retour_virement" => "Validarea  returului  dvs. [RETURN_ID]",
  "email_retour_avoir" => "Validarea  returului  dvs. [RETURN_ID]",
