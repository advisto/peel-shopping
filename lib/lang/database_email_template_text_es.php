...
// +----------------------------------------------------------------------+
// $Id: database_email_template_text_es.php 57731 2018-08-16 16:43:07Z sdelaporte $
...
Atentamente,",
  ...
  "confirm_newsletter_registration" => "Buenos dias,

Usted registró [TYPE] del sitio [SITE].
...
<a href='[CONFIRM_NEWSLETTER_REGISTER_LINK]'>[CONFIRM_NEWSLETTER_REGISTER_LINK]</a>",
  "user_double_optin_registration" => "Buenos dias,

Acaba de registrarse en [SITE]. Recordatorio de la información transmitida:
[FIELDS]

Haga clic en el enlace por debajo para activar su cuenta:
