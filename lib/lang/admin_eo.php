...
// +----------------------------------------------------------------------+
// $Id: admin_eo.php 39443 2014-01-06 16:44:24Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_ADMIN_CLICK_HERE"] = "ĉi klaku";
...
$GLOBALS["STR_ADMIN_EMAIL_TEMPLATES_TAG_WWWROOT"] = "Retadreso de la retejo";
...
$GLOBALS["STR_ADMIN_FILE"] = "Dosiero";
...
$GLOBALS["STR_ADMIN_INDEX_TITLE"] = "Administrado de {$GLOBALS['site']}";
...
$GLOBALS["STR_ADMIN_META_EMPTY_EXPLAIN"] = "La PEEL_META-tabelo malplenas.";
...
$GLOBALS["STR_ADMIN_NEWSLETTERS_WARNING"] = "Atentu: pretigi HTML-kodon de novaĵ-bulteno bezonas gravan atenton, tiel ke ĝi estu kongrua kun ĉiuj retmesaĝiloj. Vi nepre elprovu sendadon: uzado de tekstilo kiel la FCKEditor-tekstilo ĉi sube ne iluziu vin pri facileco de enpaĝigado, kiu poste povus okazigi gravajn problemojn rilate legeblecon de la mesaĝon fare de uzantoj. <a href=\"https://www.peel.fr/\" class=\"normal\" onclick=\"return(window.open(this.href)?false:true);\">Por ricevi helpon rilate kongruigo de HTML-kodo, eblas alvoki PEEL per n-o 01 75 43 67 97</a>";
...
$GLOBALS["STR_ADMIN_RUBRIQUES_ADD_ARTICLE"] = "Aldoni artikolon";
...
$GLOBALS["STR_ADMIN_TYPES_EXPLAIN"] = "Eblas ĉi paĝe difini la nomojn de liveraj manieroj. Tiuj liveraj manieroj estu poste ligitaj al liveraj kostoj. Por ŝanĝi la aperontan ordon, oni movu la vicon rilata al livera maniero ĝis la dezirata loko.";
