...
// +----------------------------------------------------------------------+
// $Id: database_email_template_name_es.php 55332 2017-12-01 10:44:06Z sdelaporte $
...
$peel_email_template["name"] = array(
  ...
  "email_ordered_cadeaux" => "Pedido sobre su lista de regalos \"[GIFTLIST_NAME]\"",
  "listecadeau_voir" => "Pedido sobre su lista de regalos \"[GIFTLIST_NAME]\"",
  ...
  "warn_admin_reve_subscription" => "Aviso de registro de un distribuidor",
  ...
  "confirm_newsletter_registration" => "Registro [TYPE] de [SITE]",
