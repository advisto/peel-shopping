...
// +----------------------------------------------------------------------+
// $Id: de.php 35371 2013-02-18 14:17:43Z gboussin $
if (!defined('IN_PEEL')) {
	die();
}

$GLOBALS["STR_ACCES_ACCOUNT"] = "Kundenlogin";
...
$GLOBALS["STR_ADD_LISTE_CADEAU"] = "Meine Wunschliste ergänzen";
...
$GLOBALS["STR_AJOUT_PENSE_BETE"] = "Notiz hinzufügen";
...
$GLOBALS["STR_ANNOUNCEMENT_INDICATION"] = "Wählen Sie aus den vorgeschlagenen Kategorien drei aus. Sie können diese Auswahl jederzeit ändern.";
...
$GLOBALS["STR_BACK"] = " <ul> <li>Gibt es auf dieser Seite einen Fehler in Ihren persönlichen Angaben, <a href=\"{$GLOBALS['wwwroot']}/achat/achat_maintenant.php\" class=\"text11\">so klicken Sie bitte hier</a>.<br /><br /></li><li>Gibt es einen Fehler in Ihrer Bestellung, <a href=\"{$GLOBALS['wwwroot']}/achat/caddie_affichage.php\" class=\"text11\">so klicken Sie hier</a>.</li> </ul>";
$GLOBALS["STR_BACK_HOME"] = "<a href=\"{$GLOBALS['wwwroot']}/\" class=\"normal\">Sie können zur Homepage zurückgehen</a>";
$GLOBALS["STR_BACK_TO_PRODUCT"] = "<< Zurück zum Produkt";
$GLOBALS["STR_BACK_TO_CADDIE_TXT"] = " <ul> <li>Gibt es auf dieser Seite einen Fehler in Ihren persönlichen Angaben, <a href=\"{$GLOBALS['wwwroot']}/achat/achat_maintenant.php\" class=\"text11\">so klicken Sie bitte hier</a>.<br /><br /></li><li>Gibt es einen Fehler in Ihrer Bestellung, <a href=\"{$GLOBALS['wwwroot']}/achat/caddie_affichage.php\" class=\"text11\">so klicken Sie hier</a>.</li> </ul>";
...
$GLOBALS["STR_CGV_OK"] = "Ich akzeptiere hiermit die <a href=\"{$GLOBALS['wwwroot']}/cgv.php\" class=\"label\" onclick=\"return(window.open(this.href)?false:true);\">Allgemeinen Geschäftsbedingungen </a> des Shops {$GLOBALS['site']}, die ich zur Kenntnis genommen habe und in die ich einwillige.";
...
$GLOBALS["STR_CODE_PROMO_REMISE"] = "Rabattcode";
...
$GLOBALS["STR_CODE_PROMO"] = "Rabattcode";
...
$GLOBALS["STR_COMMERCIAL_YES"] = "Ich willige darein ein, Updates, Angebote von {$GLOBALS['site']} und Werbeangebote von Partnern von {$GLOBALS['site']} an meine E-Mail-Adresse zu empfangen.";
...
$GLOBALS["STR_CONTACT_INTRO"] = "Informationen? <br/>Fragen? <br/>Sonderwünsche? <br/>Kontaktieren Sie uns!";
...
$GLOBALS["STR_CONTACT_US"] = "Kontaktieren Sie uns.";
...
$GLOBALS["STR_DESINSCRIPTION_NEWSLETTER"] = "Den Rundbrief abbestellen.";
...
$GLOBALS["STR_FIRST_REGISTER_TEXT"] = "Bitte füllen Sie untenstehendes Formular aus, um Ihre Bestellung aufzugeben. Pflichtfelder sind mit * markiert. Wir verkaufen Ihre persönlichen Daten nicht und geben diese auch nicht weiter. Für Fragen über die Sicherheit Ihrer persönlichen Angaben können Sie unsere Erklärung zum Schutz personenbezogener Angaben lesen oder sich an unseren Kundendienst wenden. Nutzen Sie dazu das Kontaktformular:  <a href='{$GLOBALS['wwwroot']}/utilisateurs/contact.php' title='formulaire de contact'>Kontaktformular</a>.<br /> Das Login kann zur Identifizierung verwendet werden und wird für das Abgeben von Meinungen zu dem Produkt genutzt.";
...
$GLOBALS["STR_INSERT_EMAIL"] = "Um ein neues Kennwort zu erhalten, geben Sie bitte Ihre E-Mail-Adresse an.\n\r\n\r Nach Bestätigung dieses Formulars erhalten Sie automatisch eine E-Mail.\n\r Klicken Sie auf den Link in dieser E-Mail, um ein neues Kennwort zu erstellen.";
...
$GLOBALS["STR_INVALID_TOKEN"] = "Token ungültig: Bitte versuchen Sie es erneut.";
...
$GLOBALS['STR_LEGAL_INFORMATION'] = "Rechtliche Hinweise";
...
$GLOBALS["STR_MODULE_PREMIUM_MSG_AFFILIATE"] = "Vielen Dank für Ihr Vertrauen.\n\nBitte sichern Sie Ihr Login.\n\n Nach Freigabe Ihres Kontos erhalten Sie sofort Zugang. <a href=\"{$GLOBALS['wwwroot']}/membre.php\">Zur Anmeldung klicken Sie bitte hier</a>.\n\nIhr Login lautet:";
...
$GLOBALS["STR_MODULE_PREMIUM_MSG_RETAILER"] = "Vielen Dank für Ihr Vertrauen.\n\nBitte bewahren Sie Ihr Login und Kennwort auf.\n\n Sobald Ihr Konto validiert ist, können Sie von den Wiederverkäuferpreisen profitieren. <a href=\"{$GLOBALS['wwwroot']}/membre.php\">Zum Anmelden klicken Sie hier</a>.\n\nIhr Login lautet:";
...
$GLOBALS["STR_MODULE_TELECHARGEMENT_FOR_DOWNLOAD"] = "Um die Datei zu laden, klicken Sie bitte hier";
$GLOBALS["STR_MODULE_TELECHARGEMENT_REPORT_ERROR_MAIL"] = "Senden Sie uns das Problem per E-Mail.";
$GLOBALS["STR_MODULE_TELECHARGEMENT_RETURN_ACCUEIL_DOWNLOAD"] = "<a href=\"{$GLOBALS['wwwroot']}\" class=\"normal\"><b>Klicken Sie hier,</b></a> um zur Hauptseite zurückzukehren.";
...
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_NEW_SEARCH"] = "Erstellen Sie einen neuen Alarm.";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_SEARCH"] = "Erstellen Sie einen Alarm.";
$GLOBALS["STR_MODULE_USER_ALERTS_CANT_SAVE_MORE_SEARCH"] = "Sie können keinen weiteren Alarm erstellen";
$GLOBALS["STR_MODULE_USER_ALERTS_NO_SEARCH_LIST"] = "Kein Alarm gespeichert";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_LIST"] = "Liste der gespeicherten Alarme";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_NAME"] = "Name dieses Alarms";
$GLOBALS["STR_MODULE_USER_ALERTS_MY_ALERTS"] = "Meine Alarme";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_ALERT"] = "Diesen Alarm speichern";
$GLOBALS["STR_MODULE_USER_ALERTS_SEE_ALERT_RESULTS"] = "Betrachten Sie die Ergebnisse des Alarms:";
$GLOBALS["STR_MONTH"] = "Monat";
$GLOBALS["STR_MONTHS"] = "Monate";
$GLOBALS["STR_MORE_DETAILS"] = "mehr Details";
$GLOBALS["STR_MORE"] = "Einkaufen";
$GLOBALS["STR_MSG_CHANGE_PARAMS"] = "Änderung der Einstellungen.";
$GLOBALS["STR_MSG_NEW_CUSTOMER"] = "Legen Sie ein Konto an, um auf {$GLOBALS['site']} einzukaufen.\n<a class=\"notice\" href=\"{$GLOBALS['wwwroot']}/utilisateurs/enregistrement.php\">Um ein Konto anzulegen, klicken Sie bitte hier</a>";
$GLOBALS["STR_MSG_STILL_CUSTOMER"] = "Melden Sie sich an, um Zeit zu sparen.";
...
$GLOBALS["STR_NEWSLETTER_YES"] = "Ja, ich möchte den Rundbrief von {$GLOBALS['site']} beziehen.";
$GLOBALS["STR_NEWSLETTER"] = "Rundbrief";
...
$GLOBALS["STR_OPRICES"] = "Preise zzgl. MwSt.";
...
$GLOBALS["STR_PASSWORD_CONFIRMATION"] = "Geben Sie Ihr Kennwort erneut ein";
$GLOBALS["STR_PASSWORD_EMAIL"] = "Wir haben Ihnen eine E-Mail gesandt.\n\nFolgen Sie den Anweisungen darin.\n\n";
$GLOBALS["STR_PASSWORD_SECURITY"] = "Sicherheit des Kennworts<br />";
...
$GLOBALS["STR_PORTABLE"] = "Mobilnummer";
...
$GLOBALS["STR_SEARCH_HELP"] = "<h2>Suchhilfe</h2><ul><li>Die Ergebnisse beinhalten alle Suchbegriffe, ohne Groß- oder Kleinschreibung zu beachten. Beispiel: Die Suche nach Tisch Teakholz gibt alle Ergebnisse aus, die beide Begriffe beinhalten.</li>
<li>Das Zeichen (\") ermöglicht die Suche nach Sätzen. In diesem Fall ergibt die Suche nach \"Tisch Teakholz\" alle Ergebnisse, die genau diese Wortfolge mit Leerzeichen enthalten.</li>
<li>Das Zeichen (-) schließt einen Suchbegriff aus. In diesem Fall ergibt die Suche nach Tisch -Teakholz alle Ergebnisse mit dem Suchbegriff Tisch, aber ohne den Suchbegriff Teakholz. Sie können auch das Zeichen (-) vor einem Satz mit dem Zeichen (\") einfügen, wie zum Beispiel Tisch -\"massives Teakholz\".</li></ul>";
...
$GLOBALS["STR_STILL_CUSTOMER"] = "Schon Kunde?";
$GLOBALS["STR_STOCK_ATTRIBUTS"] = "Vorrat";
$GLOBALS["STR_STOCK"] = "Vorratsangaben";
$GLOBALS["STR_STRONG_PASSWORD_NOTIFICATION"] = "Sichere Kennwörter enthalten 7 - 16 Zeichen sowie Groß- und Kleinbuchstaben, Ziffern und Symbole, aber weder Wörter aus dem Wörterbuch noch Namen.";
$GLOBALS["STR_STRONG_PSEUDO_NOTIFICATION"] = "Das Pseudonym darf nicht den Klammeraffen (@) enthalten.";
$GLOBALS["STR_SUBMIT"] = "Validieren";
$GLOBALS["STR_SUGGEST"] = "Ihr Guthaben erlaubt es, weitere Produkte zu erhalten.<a href=\"achat/suggest.php\" class=\"label\">Schauen Sie sich doch einmal unsere Empfehlungen an, um Ihren Einkauf zu komplettieren</a>.";
...
$GLOBALS["STR_TEL"] = "Tel.";
$GLOBALS["STR_TELEPHONE"] = "Telefon";
$GLOBALS["STR_TELL_FRIEND"] = "Per E-Mail an eine Freundin senden";
...
$GLOBALS["STR_TICKET_OK"] = "Ihre Nachricht wurde versandt.\nEin Berater wird sich an Sie wenden.";
...
$GLOBALS["STR_VALIDATION_CODE_COPY"] = "Kopieren Sie den Verfizierungscode.";
$GLOBALS["STR_VALIDATION_CODE"] = "Überprüfungskode";
...
$GLOBALS["STR_WARNING_SIZE_PICTURE_ADS"] = "Achtung: Halten Sie beim Einfügen von Bildern in die Beschreibung dieses Format ein.<br />Ihre Bilder dürfen höchstens 600 Pixel haben.";
