...
// +----------------------------------------------------------------------+
// $Id: es.php 35371 2013-02-18 14:17:43Z gboussin $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_ADD_LISTE_CADEAU"] = "añadir a mi lista de regalos";
...
$GLOBALS["STR_BACK_HOME"] = "<a href=\"{$GLOBALS['wwwroot']}/\" class=\"normal\">Usted puede volver a la página de inicio</a>";
$GLOBALS["STR_BACK_TO_PRODUCT"] = " << Volver al producto";
$GLOBALS["STR_BACK_TO_CADDIE_TXT"] = "<ul>	<li>Si une erreur concernant vos informations personnelles figure sur cette page, <a href=\"javascript:history.back()\" class=\"text11\">cliquez ici</a>.</li>\n	<li>Si une erreur concernant votre commande figure sur cette page, <a href=\"{$GLOBALS['wwwroot']}/achat/caddie_affichage.php\" class=\"text11\">cliquez ici</a>.</li></ul>";
...
$GLOBALS["STR_CATALOG"] = "Nuestro catàlogo";
$GLOBALS["STR_CATALOGUE"] = "Catalogo";
$GLOBALS["STR_CATEGORY"] = "Categoría";
$GLOBALS["STR_CGV_OK"] = "He leídolas <a href=\"{$GLOBALS['wwwroot']}/cgv.php\" class=\"label\" onclick=\"return(window.open(this.href)?false:true);\">condiciones generales de venta</a> del sitio {$GLOBALS['site']} en vigor en ese momento y me apoya plenamente.";
...
$GLOBALS["STR_CONTACT_INTRO"] = "¿Necesita más información?<br /> ¿Preguntas?<br />¿una petición especial?<br />Contacte con nosotros!";
...
$GLOBALS["STR_EMAIL_OR_PSEUDO"] = "Alias / pseudo";
...
$GLOBALS["STR_ERR_NEWPASS"] = "Usted no ha ingresado una nueva contraseña.\n";
...
$GLOBALS["STR_ERR_PASSWORD"] = "Usted no ha completado su contraseña.\n";
...
$GLOBALS["STR_GIFT_CATALOGUE"] = "catálogo de regalos";
...
$GLOBALS["STR_INVALID_TOKEN"] = "Token no válido: el tratamiento ya realizados o HTTP Referer no se le informó por su navegador";
...
$GLOBALS["STR_MODULE_AVIS_NO_OPINION_FOR_THIS_PRODUCT"] = "Actualmente, ningún opinión han sido enviados para este producto";
...
$GLOBALS["STR_MODULE_AVIS_YOUR_COMMENT_WAITING_FOR_VALIDATION"] = "Su opinión ha sido registrado.<br /> Después de la validación de este último, se publicará en";
$GLOBALS["STR_MODULE_BANNER_MSG_ERR_DATE"] = "Usted debe completar la fecha.\n";
$GLOBALS["STR_MODULE_CART_POPUP_CART_POPUP_PRODUCT_ADDED"] = "El producto fue añadido";
...
$GLOBALS["STR_MODULE_TELECHARGEMENT_FOR_DOWNLOAD"] = "Para descargar el archivo, haga clic aquí";
$GLOBALS["STR_MODULE_TELECHARGEMENT_REPORT_ERROR_MAIL"] = "Encontrado el problema mediante el envío de un correo electrónico.";
$GLOBALS["STR_MODULE_TELECHARGEMENT_RETURN_ACCUEIL_DOWNLOAD"] = "<a href=\"{$GLOBALS['wwwroot']}\" class=\"normal\"><b>Haz clic aquí</b></a> para volver a la casa.";
...
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_NEW_SEARCH"] = "Crear una nueva alerta.";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_SEARCH"] = "Crear una alerta";
$GLOBALS["STR_MODULE_USER_ALERTS_CANT_SAVE_MORE_SEARCH"] = "No se puede agregar advertencia adicional";
$GLOBALS["STR_MODULE_USER_ALERTS_NO_SEARCH_LIST"] = "No está alerto guardado";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_LIST"] = "Lista de alertas guardadas";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_NAME"] = "Nombre esta alerta";
$GLOBALS["STR_MODULE_USER_ALERTS_MY_ALERTS"] = "Mis alertas";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_ALERT"] = "Guardar esta alerta";
$GLOBALS["STR_MODULE_USER_ALERTS_SEE_ALERT_RESULTS"] = "Ver los resultados de alerta:";
...
$GLOBALS["STR_NAISSANCE"] = "Fecha de nacimiento (JJ/MM/AAAA)";
...
$GLOBALS["STR_SEND_TRANSFER"] = "Realizar su pago al cuento bancario siguiente";
$GLOBALS["STR_SEND"] = "Publicar";
...
$GLOBALS["STR_STRONG_PASSWORD_NOTIFICATION"] = "Las contraseñas fuertes contienen de 7 a 16 carácteres, no contienen ni palabras ni nombres corrientes y asocian mayúsculas, minúsculas, cifras y símbolos.";
$GLOBALS["STR_STRONG_PSEUDO_NOTIFICATION"] = "El pseudo no debe contener el signo de arroba(\"@\")";
$GLOBALS["STR_SUBMIT"] = "Validar";
$GLOBALS["STR_SUGGEST"] = "Su abono le permite de obtener productos complementarios. <a href=\"achat/suggest.php\" class=\"label\">Le invitamos a visitar nuestra lista de sugerencias para completar su compra</a>.";
...
$GLOBALS["STR_VALIDATION_CODE_COPY"] = "Copiar el codigo de verificación";
