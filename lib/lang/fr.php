...
// +----------------------------------------------------------------------+
// $Id: fr.php 39495 2014-01-14 11:08:09Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
...
$GLOBALS["STR_ADD_LISTE_CADEAU"] = "Ajouter à ma liste cadeaux";
...
$GLOBALS["STR_BOUGHT_FACTURE"] = "Pour régler votre commande en ligne, cliquez ici";
...
$GLOBALS["STR_CONTACT_SUBJECT"] = "Votre question concerne";
...
$GLOBALS["STR_ERR_NEWPASS"] = "Vous n'avez pas entré de nouveau mot de passe.\n";
...
$GLOBALS["STR_ERR_PASSWORD"] = "Vous n'avez pas précisé votre mot de passe.\n";
...
$GLOBALS["STR_IF_DOWNLOAD_PROBLEM"] = "Si le lien pour télécharger le script n'est plus valide, vous pouvez";
...
$GLOBALS["STR_INVALID_TOKEN"] = "Token invalide : traitement déjà réalisé ou Referer HTTP non renseigné par votre navigateur";
...
$GLOBALS["STR_MODULE_PREMIUM_TOP_PAGE"] = "Haut de page";
...
$GLOBALS["STR_MODULE_TELECHARGEMENT_FOR_DOWNLOAD"] = "Pour télécharger le fichier, cliquez ici";
$GLOBALS["STR_MODULE_TELECHARGEMENT_REPORT_ERROR_MAIL"] = "Nous signaler le problème en nous envoyant un email.";
$GLOBALS["STR_MODULE_TELECHARGEMENT_RETURN_ACCUEIL_DOWNLOAD"] = "<a href=\"{$GLOBALS['wwwroot']}\" class=\"normal\"><b>Cliquez ici</b></a> pour revenir à l'accueil.";
...
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_NEW_SEARCH"] = "Créer une nouvelle alerte.";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_SEARCH"] = "Créer une alerte";
$GLOBALS["STR_MODULE_USER_ALERTS_CANT_SAVE_MORE_SEARCH"] = "Vous ne pouvez pas ajouter d'alerte supplémentaire";
$GLOBALS["STR_MODULE_USER_ALERTS_NO_SEARCH_LIST"] = "Pas d'alerte sauvegardée";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_LIST"] = "Liste de vos alertes sauvegardées";
$GLOBALS["STR_MODULE_USER_ALERTS_SEARCH_NAME"] = "Nom de cette alerte";
$GLOBALS["STR_MODULE_USER_ALERTS_MY_ALERTS"] = "Mes alertes";
$GLOBALS["STR_MODULE_USER_ALERTS_SAVE_ALERT"] = "Sauvegarder cette alerte";
$GLOBALS["STR_MODULE_USER_ALERTS_SEE_ALERT_RESULTS"] = "Voir les résultats de l'alerte : ";
...
$GLOBALS["STR_VALIDATION_CODE_COPY"] = "Recopiez le code de vérification";
