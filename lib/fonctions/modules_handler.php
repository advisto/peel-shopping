...
// +----------------------------------------------------------------------+
// $Id: modules_handler.php 35805 2013-03-10 20:43:50Z gboussin $
...
/**
 * is_produit_cadeaux_module_active()
 *
 * @return
 */
function is_produit_cadeaux_module_active() {
	if(file_exists($GLOBALS['fichierproduitscadeaux'])){
		return true;
	 }else{
		return false;
	 }
