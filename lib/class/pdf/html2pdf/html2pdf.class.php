...
//require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/tcpdfConfig.php');
require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/exception.class.php');
require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/locale.class.php');
require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/myPdf.class.php');
require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/parsingHtml.class.php');
require_once($GLOBALS['dirroot'].'/lib/class/pdf/html2pdf/_class/parsingCss.class.php');
