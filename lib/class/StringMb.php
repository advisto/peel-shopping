...
// +----------------------------------------------------------------------+
// $Id: StringMb.php 60372 2019-04-12 12:35:34Z sdelaporte $
if (!defined('IN_PEEL')) {
	die();
}
 ...
 * @version $Id: StringMb.php 60372 2019-04-12 12:35:34Z sdelaporte $
 * @access public
 */
class StringMb {
	/**
	...
	{
		if (!empty($GLOBALS['site_parameters']['compatibility_mode_with_htmlentities_encoding_content']) && StringMb::strpos($string, '&') !== false && StringMb::strpos($string, '<') === false) {
