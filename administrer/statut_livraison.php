...
// +----------------------------------------------------------------------+
// $Id: statut_livraison.php 55332 2017-12-01 10:44:06Z sdelaporte $
...
{
	$sql = "UPDATE peel_statut_livraison SET position='" . intval($frm['position']) . "', site_id='" . nohtml_real_escape_string(get_site_id_sql_set_value($frm['site_id'])) . "', technical_code='" . nohtml_real_escape_string($frm['technical_code']) . "'";
	foreach ($GLOBALS['admin_lang_codes'] as $lng) {
